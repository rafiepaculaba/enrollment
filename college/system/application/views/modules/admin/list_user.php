<form id="frmUserList" name="frmUserList" method="POST" action="index.php?admin/list_user">
...
<tr height="20">
	...
	<slot>
		<select name="deptID">
			<option value="">--------</option>
			<option <?php if($deptID == '1') { echo 'selected'; } ?> value="1">CPD</option>
			<option <?php if($deptID == '2') { echo 'selected'; } ?> value="2">DOH</option>
		</select>
	</slot>
	</td>
	<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1">
...
<tr onMouseOver="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onMouseOut="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onMouseDown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
	<td scope="row" class="evenListRowS1" bgcolor="#fdfdfd" nowrap ><span sugar="sugar0b"><a href="index.php?admin/view_user/<?php echo $row->userID ?>" class="listViewTdLinkS1"> <?php echo $row->lastName?></a></span> &nbsp;</td>
	<td scope="row" class="evenListRowS1" bgcolor="#fdfdfd" nowrap ><span sugar="sugar0b"><a href="index.php?admin/view_user/<?php echo $row->userID ?>" class="listViewTdLinkS1"> <?php echo $row->firstName?></a></span> &nbsp;</td>
	<td scope="row" class="evenListRowS1" bgcolor="#fdfdfd" nowrap ><span sugar="sugar0b"><a href="index.php?admin/view_user/<?php echo $row->userID ?>" class="listViewTdLinkS1"> <?php echo $row->middleName?></a></span> &nbsp;</td>
	<td scope="row" class="evenListRowS1" bgcolor="#fdfdfd" nowrap ><?php echo $row->deptID?> &nbsp;</td>
