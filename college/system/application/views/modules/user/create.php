...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="dataLabel" align="right" ><slot>Password <span class="required">*</span></slot></td>
      	<td class="dataField" ><slot><input type="password" size="40" name="userPswd" id="userPswd" value="" /></slot></td>
	</tr>
	<tr>
		<td class="dataLabel" align="right" ><slot>Re-type Password <span class="required">*</span></slot></td>
      	<td class="dataField" ><slot><input type="password" size="40" name="reuserPswd" id="reuserPswd"value="" /></slot></td>
	</tr>
	<tr>
		...
		<td>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody><tr>
					...
					<th class="dataLabel" colspan="4" align="left" width="100%"><h4 class="dataLabel"><slot>User Settings</slot></h4></th>
				</tr>
				<tr>
					<td class="dataLabel" width="20%"><slot>Administrator</slot></td>
					<td class="dataField" width="15%"><slot><input name="is_admin" id="is_admin" class="checkbox" type="checkbox"></slot></td>
					<td class="dataField" width="65%"><slot>Grants administrator privileges to this user</slot></td>
				</tr>
			</tbody></table>
		</td>
	</tr>
...
function setAdmin()
{
    if (document.getElementById('groupID').value==1) {
        ...
        document.getElementById('is_admin').disabled=false;
        document.getElementById('is_admin').checked=true;
    } else {
        document.getElementById('is_admin').disabled=true;
