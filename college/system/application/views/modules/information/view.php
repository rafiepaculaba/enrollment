                ...
                <tr>
                    ...
                    <?php 
			            ...
			            foreach ($allowed_filetypes as $value) {
			                if (is_file("../uploads/col_students/".$row->idno.$value)) {
			                    $image = "../uploads/col_students/".$row->idno.$value;
			                    break;
			                }	
			            }
                    	if(is_file($image)){
    ...
    <tr>
        <td width="70%" valign="top">
			...
			<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
			    ...
			    <tr>
			        <td class="tabDetailViewDL" width="25%"><slot>Year :</slot></td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td class="tabDetailViewDF" width="32%"><slot><?php echo $row->primary_edu; ?></slot></td>
        <td class="tabDetailViewDL" width="18%"><slot>School Year  :</slot></td>
        <td class="tabDetailViewDF" width="32%"><slot><?php echo $row->primary_schYear; ?></slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL" width="18%"><slot>Intermidiate :</slot></td>
        <td class="tabDetailViewDF" width="32%"><slot><?php echo $row->interm_edu; ?></slot></td>
        <td class="tabDetailViewDL" width="18%"><slot>School Year  :</slot></td>
        <td class="tabDetailViewDF" width="32%"><slot><?php echo $row->interm_schYear; ?></slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL" width="18%"><slot>Secondary :</slot></td>
        <td class="tabDetailViewDF" width="32%"><slot><?php echo $row->hs_edu; ?></slot></td>
        <td class="tabDetailViewDL" width="18%"><slot>School Year  :</slot></td>
        <td class="tabDetailViewDF" width="32%"><slot><?php echo $row->hs_schYear; ?></slot></td>
    </tr>
</table>
</p>
