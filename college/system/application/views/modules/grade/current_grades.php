...
<tr><td>
   <table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td class="tabDetailViewDF" colspan="3"><slot><?php echo $row->idno; ?></slot></td>
    </tr>
    <tr>
...
<tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" width="15%" nowrap>Instructor</td>
		<td scope="col" class="listViewThS1" width="15%" nowrap>Schedule</td>
	...
	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
        ...
        {/if}
        align="left" bgcolor="#fdfdfd" valign="top"><?php echo $value->pregrade; ?></td>
        ...
        {else}
            class="oddListRowS1" bgcolor="#ffffff" 
        {/if}
        align="left" bgcolor="#fdfdfd" valign="top"><?php echo $value->mgrade; ?></td>
        ...
        {else}
            class="oddListRowS1" bgcolor="#ffffff" 
        {/if}
        align="left" bgcolor="#fdfdfd" valign="top"><?php echo $value->prefigrade; ?></td>
        ...
        {else}
            class="oddListRowS1" bgcolor="#ffffff" 
        {/if}
        align="left" bgcolor="#fdfdfd" valign="top"><?php echo $value->fgrade; ?></td>
        ...
        align="left" bgcolor="#fdfdfd" valign="top">
		<?php 
			if(strlen($subject[0]->descTitle) >= 50) {
				echo substr($subject[0]->descTitle, 0, 50).'...'; 
			} else {
				echo $subject[0]->descTitle; 
			}
		?></td>
	...
	?>
	<tr>
		<td bgcolor="#fdfdfd" align="right" valign="top" class="evenListRowS1" scope="row" colspan="10"><b>TOTAL UNITS : </b>&nbsp;&nbsp;&nbsp;&nbsp; </td>
		<td scope="row"
        {if i%2 eq 0}
            class="evenListRowS1" bgcolor="#fdfdfd" 
        {else}
