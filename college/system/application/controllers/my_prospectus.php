<?php
class My_prospectus extends Controller 
{
	var $module_menu;
	var $subjects11;
	var $subjects12;
    ...
    var $ctr = 0;
    var $enID11;
	var $subj11_legend=array();
	var $subj12_legend=array();
	var $subj21_legend=array();
	var $subj22_legend=array();
	var $subj31_legend=array();
	var $subj32_legend=array();
	var $subj41_legend=array();
	var $subj42_legend=array();
	var $currID;
	var $rstatus;
	
	
	function My_prospectus()
	{
		parent::Controller();
        //menu settings
		$this->Menu_model->my_prospectus();
    ...
    function index()
	{
		...
		$this->load->view('modules/my_prospectus/view');
