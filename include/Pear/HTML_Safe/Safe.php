...
class HTML_Safe
{
    ...
    function parse($doc)
    {
	   ...
	   // Bug No : 13697
	   // commented out because this API is expecting an encoded data but the data passed in this scenario
	   // contains "+4" which it tries to decodes it and results in junk characters
