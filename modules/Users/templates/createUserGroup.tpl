...
<tbody><tr>
	<td style="padding-bottom: 2px;"><input title="Save [Alt+S]" accesskey="S" class="button" onclick="this.form.action.value='Save';" name="cmdsave" value="  Save  " type="submit"> <input title="Cancel [Alt+X]" accesskey="X" class="button" onclick="javascript: window.location='index.php?module=CCP&action=listCCP'" name="button" value="  Cancel  " type="button"></td>
