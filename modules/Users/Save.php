...
if ($_POST['groupID'] && $return_id) {
    ...
    if ($theGroupRoles) {
        ...
        foreach($theGroupRoles as $row) {
            ...
            $u->addUserRole($newID, $roleID, $userID);
        }
    }
}
