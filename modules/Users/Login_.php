...
<tr>
<td class="body"  style="padding-bottom: 10px;" width="300" ><b><? echo $mod_strings['LBL_LOGIN_WELCOME_TO']; ?></b><br>
<IMG src="include/images/company_logo.gif" width="222" height="46" alt="Sugar">&nbsp;Beta 1.0</td>
</tr>
<tr>
<td class="tabForm" align="center">
		...
		<tr>
			...
			<input type="hidden" name="login_theme" value="Sugar">
...
// echo \"$login_user_name\"/>"; if (!empty($sugar_config['default_user_name'])) echo " ({$sugar_config['default_user_name']})";
// if (!empty($sugar_config['default_password'])) echo " ({$sugar_config['default_password']})"; 

?>
		<tr>
			<td class="dataLabel" width="30%"><?php echo $current_module_strings['LBL_USER_NAME'] ?></td>
			<td width="70%">
			<input id="user_name" name="user_name" value="<?php echo $login_user_name; ?>">
            </td>
		</tr>
		<tr>
			<td class="dataLabel"><?php echo $current_module_strings['LBL_PASSWORD'] ?></td>
			<td width="70%">
			<input type="password" id="user_password" name="user_password" value="<?php echo $login_password; ?>">
            </td>
		</tr>
		<tr>
			<td>&nbsp;</td>
