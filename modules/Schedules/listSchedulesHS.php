...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$subjID     	= $_SESSION[$_GET['module'].'HS_subjID'];
		$noEnrolled     = $_SESSION[$_GET['module'].'HS_noEnrolled'];
		$profID     	= $_SESSION[$_GET['module'].'HS_profID'];
		$room 	    	= $_SESSION[$_GET['module'].'HS_room'];
	...
	$_SESSION[$_GET['module'].'HS_subjID']		= $subjID;
	$_SESSION[$_GET['module'].'HS_noEnrolled']	= $noEnrolled;
	$_SESSION[$_GET['module'].'HS_profID']		= $profID;
	$_SESSION[$_GET['module'].'HS_room']		= $room;
...
//	$allSchedules = $sched->retrieveAllSchedulesAssociated($conds);
	...
	$main_url="index.php?module=SchedulesHS&action=listSchedules&schYear=$schYear&yrLevel=$yrLevel&schedCode=$schedCode&subjID=$subjID&noEnrolled=$noEnrolled&profID=$profID&room=$room&rstatus=$rstatus";
    ...
    $print_link = "index.php?module=Schedules&action=printSchedulesHS&schYear=$schYear&droom=$droom&dnoEnrolled=$dnoEnrolled&dmaxCapacity=$dmaxCapacity&dstartTime=$dstartTime&dendTime=$dendTime&dremarks=$dremarks&ddays=$ddays&sugar_body_only=1";
	...
	echo $sugar_smarty->fetch('modules/Schedules/templates/listSchedulesHS.tpl');
} else {
