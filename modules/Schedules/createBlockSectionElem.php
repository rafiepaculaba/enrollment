...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    echo $sugar_smarty->fetch('modules/Schedules/templates/createBlockSectionElem.tpl');
} else {
...
//    if ($('schYear').value && $('yrLevel').value) {
        get_data="schYear=" + $('schYear').value + "&yrLevel=" + $('yrLevel').value + "&action=getscheduleselem";
...
function onCheckDuplicateSection()
{
    if ( check_form('frmBlockSection') ) {
        get_data="schYear=" + $('schYear').value + "&yrLevel=" + $('yrLevel').value + "&secName=" + $('secName').value + "&action=checkduplicatesectionelem";
...
{
    get_data="schedID=" + $('schedID').value + "&action=checksubjectlevelelem";
...
{
    get_data="schedID=" + $('schedID').value + "&action=checkconflictelem";
...
{
    get_data="schedID=" + $('schedID').value + "&action=addscheduleelem";
