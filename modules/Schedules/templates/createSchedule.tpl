			...
			<tr>
		        ...
		        <slot>
					<div id="divCurriculums">
			            ...
			            <option value="{$curriculum_list[i].curID}">{$curriculum_list[i].curName} - {$curriculum_list[i].major} </option>
			            {/section}
			            </select>
			        </div>
		        </slot>
			...
			<tr>
		        ...
		        <slot>
					<div id="divSubjects">
			            ...
			            <option value="{$subject_list[i].curID}">{$subject_list[i].subjCode} {$subject_list[i].descTitle} {if $subject_list[i].type eq 2} (Lab){/if}</option>
			            {/section}
			            </select>
			        </div>
		        </slot>
