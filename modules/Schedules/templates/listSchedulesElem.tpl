<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td nowrap="nowrap"><h3><img src="themes/Sugar/images/h3Arrow.gif" border="0" height="11" width="11">&nbsp;ELEMENTARY SCHEDULES</h3></td>
	</tr>
	<tr>
...
<input type="hidden" name="action" value="listSchedulesElem" />
<p>
	...
	{if $list neq ""}
		...
		<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Schedules&action=viewScheduleElem&schedID={$list[i].schedID}" class="listViewTdLinkS1">{$list[i].schedCode}</a><span></td>	
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><img src="themes/Sugar/images/classroster.gif" border="0" onclick="popUp('index.php?module=Reports&action=classRosterElem&schedID={$list[i].schedID}&sugar_body_only=1');"><span></td>	
