<form name="frmSchedulePreschool" id="frmSchedulePreschool" method="post" action="index.php?module=Schedules&action=saveSchedulePreschool" >
<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="validateTime();"/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=Schedules&action=listSchedulesPreschool')" />
    </td>
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td>
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		    <tr>
		        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Create Preschool Schedule</h4></th>
		    </tr>
   			<tr>
			...
			<tr>
		        ...
		        <slot>
			            ...
			            <option value="{$subject_list[i].subjID}">{$subject_list[i].subjCode} {$subject_list[i].descTitle} {if $subject_list[i].type eq 2} (Lab){/if}</option>
			            {/section}
			            </select>
		        </slot>
			</tr>
