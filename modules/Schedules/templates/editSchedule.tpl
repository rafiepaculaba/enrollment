<form method="post" name="frmSchedule" id="frmSchedule" action="index.php?module=Schedules&action=saveSchedule" >
...
<input type="hidden" name="prevsemCode" id="prevsemCode" value="{$semCode}" />
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td>
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		    <tr>
		        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit College Schedule</h4></th>
		    </tr>
			<tr>
			...
			<tr>
		        ...
		        <td class="dataField" width="82%"><slot>{$SEMESTERS}</slot>
		   	</tr>
			<tr>
			...
			<tr>
		        ...
		        <slot>
					<div id="divCurriculums">
			            ...
			            <option value="">----------------------------------------------------------------------------------------------</option>
			            {section name=i loop=$curriculum_list}
			            <option value="{$curriculum_list[i].curID}" {if $curriculum_list[i].curID eq $curID} selected {/if}>
			            {$curriculum_list[i].curName} - {$curriculum_list[i].major} </option>
			            {/section}
			            </select>
			        </div>
		        </slot>
