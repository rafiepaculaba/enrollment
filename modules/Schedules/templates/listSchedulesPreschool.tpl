<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td nowrap="nowrap"><h3><img src="themes/Sugar/images/h3Arrow.gif" border="0" height="11" width="11">&nbsp;Preschool SCHEDULES</h3></td>
	</tr>
	<tr>
...
<input type="hidden" name="action" value="listSchedulesPreschool" />
<p>
...
<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap>Grade Level</td>
		<td scope="col" class="listViewThS1" nowrap>Sched Code</td>
		<td scope="col" class="listViewThS1" nowrap>Subject</td>
		<td scope="col" class="listViewThS1" nowrap>Teacher </td>
		{if $droom eq 1}
	...
	<tr height="20">
		...
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1" ><slot>{$YEARLEVEL}</slot></td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="schedCode" id="schedCode" size="" value="{$schedCode}" maxlength="10" onkeypress="return keyRestrict(event, 0);"/></td>
		...
		{if $dremarks eq 1}
		  <td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1">&nbsp;</td>
		{/if}        <td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="submit" name="cmdFilter" id="cmdFilter" value="Filter"/></td>
		</form>
	</tr>
	<tr>
	...
	{if $list neq ""}
		...
		<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Schedules&action=viewSchedulePreschool&schedID={$list[i].schedID}" class="listViewTdLinkS1">{$list[i].schedCode}</a><span></td>	
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><img src="themes/Sugar/images/classroster.gif" border="0" onclick="popUp('index.php?module=Reports&action=classRosterPreschool&schedID={$list[i].schedID}&sugar_body_only=1');"><span></td>	
