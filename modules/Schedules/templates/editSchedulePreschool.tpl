<form method="post" name="frmSchedulePreschool" id="frmSchedulePreschool" action="index.php?module=Schedules&action=saveSchedulePreschool" >
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td>
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		    <tr>
		        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Preschool Schedule</h4></th>
		    </tr>
			<tr>
