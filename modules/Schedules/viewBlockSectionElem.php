...
$accessCode = $access->getAccessCode("View Elem Block Section");
...
if ($access->check_access($current_user->id, $accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete Elem Block Section");
    $sugar_smarty->assign('hasDelete', $access->check_access($current_user->id, $accessCode) );
    
    
    echo $sugar_smarty->fetch('modules/Schedules/templates/viewBlockSectionElem.tpl');
...
function deleteBlockSection(secID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Schedules&action=deleteBlockSectionElem&secID='+secID);
}
