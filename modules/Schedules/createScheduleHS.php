...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/Schedules/templates/createScheduleHS.tpl');
} else {
...
addToValidate('frmScheduleHS','schedCode', '', true, 'Sched Code');
...
{ 
		...
		get_data="schYear=" + $('schYear').value + "&startTime=" + startTime + "&endTime=" + endTime + "&onMon=" + onMon + "&onTue=" + onTue + "&onWed=" + onWed + "&onThu=" + onThu + "&onFri=" + onFri + "&onSat=" + onSat + "&onSun=" + onSun + "&room=" + $('room').value + "&action=checkconflicths";
