...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $secName   = $_SESSION[$_GET['module'].'HS_secName'];
    ...
    $_SESSION[$_GET['module'].'HS_secName']  = $secName;
...
//    	$total_rec=0;
    ...
    $main_url="index.php?module=Schedules&action=listBlockSectionsHS&secID=$secID&secName=$secName&schYear=$schYear&yrLevel=$yrLevel&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Schedules/templates/listBlockSectionsHS.tpl');
} else {
