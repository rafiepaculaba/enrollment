...
$accessCode = $access->getAccessCode("View Preschool Schedule");
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete Preschool Schedule");
    $sugar_smarty->assign('hasDelete', $access->check_access($current_user->id, $accessCode) );
	
	echo $sugar_smarty->fetch('modules/Schedules/templates/viewSchedulePreschool.tpl');
} else {
...
function deleteSchedule(schedID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Schedules&action=deleteSchedulePreschool&schedID='+schedID);
}
</script>