...
$accessCode = $access->getAccessCode("View HS Block Section");
...
if ($access->check_access($current_user->id, $accessCode)) {
    ...
    echo $sugar_smarty->fetch('modules/Schedules/templates/viewBlockSectionHS.tpl');
...
function deleteBlockSection(secID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Schedules&action=deleteBlockSectionHS&secID='+secID);
}
