...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $offset = $_GET['offset']? $_GET['offset']:0;
     ...
     if ($_GET['cmdFilter']) {
        ...
        $secName   = $_SESSION[$_GET['module'].'Preschool_secName'];
    ...
    $_SESSION[$_GET['module'].'Preschool_secName']  = $secName;
...
//    	$total_rec=0;
    ...
    $main_url="index.php?module=Schedules&action=listBlockSectionsPreschool&secID=$secID&secName=$secName&schYear=$schYear&yrLevel=$yrLevel&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Schedules/templates/listBlockSectionsPreschool.tpl');
} else {
