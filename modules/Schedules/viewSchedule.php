...
$accessCode = $access->getAccessCode("View Col Schedule");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	switch ( $sched->semCode ) 
	{
		case 1:
			$semCode="1"."<sup>"."st"."</sup>". " Sem"	;
			break;
		case 2:
			$semCode="2"."<sup>"."nd"."</sup>". " Sem"	;
			break;
		case 4:
			$semCode="Summer"	;
			break;
	...
	$sugar_smarty->assign('courseCode', $sched->courseCode );
	...
	echo $sugar_smarty->fetch('modules/Schedules/templates/viewSchedule.tpl');
} else {
...
function deleteSchedule(schedID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Schedules&action=deleteSchedule&schedID='+schedID);
}
</script>