...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    echo $sugar_smarty->fetch('modules/Schedules/templates/createBlockSectionPreschool.tpl');
} else {
...
function onCheckDuplicateSection()
{
    if ( check_form('frmBlockSection') ) {
        get_data="schYear=" + $('schYear').value + "&yrLevel=" + $('yrLevel').value + "&secName=" + $('secName').value + "&action=checkduplicatesectionpreschool";
