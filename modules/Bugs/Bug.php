...
//		$this->assigned_user_name = get_assigned_user_name($this->assigned_user_id);
		...
		$query .= "
                               bugs.*
                                ...
                                ,users.user_name as assigned_user_name, releases.id release_id, releases.name fixed_in_release_name";
		...
		$query .= "				LEFT JOIN releases ON bugs.fixed_in_release=releases.id
								LEFT JOIN users
