...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($user->groupID==8) {
	    ...
	    $conds[0]['groupID']="=8";  // assuming the groupID 6 is college insctructor
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/createGradeSheetElem.tpl');
} else {
...
function checkDuplicateHandle()
{
	if (xmlHttp.readyState==4) {
    	...
    	if (parseInt(ret)==1) {
        	...
        	$('students').innerHTML = '	<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"> <tbody><tr height="20"><td scope="col" class="listViewThS1" nowrap>&nbsp;</td>	<td scope="col" class="listViewThS1" nowrap>ID No.</td><td scope="col" class="listViewThS1" nowrap>Student Name</td><td scope="col" class="listViewThS1" nowrap>Grade</td>      <td scope="col" class="listViewThS1" nowrap>1<sup>st</sup></td>       <td scope="col" class="listViewThS1" nowrap>2<sup>nd</sup></td>        <td scope="col" class="listViewThS1" nowrap>3<sup>rd</sup></td>        <td scope="col" class="listViewThS1" nowrap>4<sup>th</sup></td>       <td scope="col" class="listViewThS1" nowrap>Final</td>	</tr></tbody></table>';
