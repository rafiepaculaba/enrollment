...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $gsID      = $_SESSION[$_GET['module'].'Preschool_gsID'];
    ...
    $_SESSION[$_GET['module'].'Preschool_gsID']        = $gsID;
    ...
    $main_url="index.php?module=Grades&action=listGradesheetsPreschool&gsID=$gsID&schedCode=$schedCode&subjCode=$subjCode&profID=$profID&schYear=$schYear&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/listGradesheetsPreschool.tpl');
} else {
