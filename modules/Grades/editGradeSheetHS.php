...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/editGradeSheetHS.tpl');
} else {
...
function getSchedules()
{
	...
	$('students').innerHTML = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>	<tr height="20">	    <td scope="col" class="listViewThS1" width="2%" nowrap>&nbsp;</td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>1<sup>st</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>2<sup>nd</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>3<sup>rd</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>4<sup>th</sup></td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Final</td>		<td scope="col" class="listViewThS1" width="15%" nowrap>ID No.</td>		<td scope="col" class="listViewThS1" width="45%" nowrap>Student Name</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Course</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Year</td>	</tr></tbody></table>';
...
function getSubject()
{
   if (trim($('schedID').value)!="") {
    	...
    	$('students').innerHTML = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>	<tr height="20">	    <td scope="col" class="listViewThS1" width="2%" nowrap>&nbsp;</td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>1<sup>st</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>2<sup>nd</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>3<sup>rd</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>4<sup>th</sup></td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>Grade</td>		<td scope="col" class="listViewThS1" width="15%" nowrap>ID No.</td>		<td scope="col" class="listViewThS1" width="45%" nowrap>Student Name</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Course</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Year</td>	</tr></tbody></table>';
    }
}
