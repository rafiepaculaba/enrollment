...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $idno   = $_SESSION[$_GET['module'].'PreschoolFG_idno'];
        $lname  = $_SESSION[$_GET['module'].'PreschoolFG_lname'];
        $fname  = $_SESSION[$_GET['module'].'PreschoolFG_fname'];
        $mname  = $_SESSION[$_GET['module'].'PreschoolFG_mname'];
        $yrLevel = $_SESSION[$_GET['module'].'PreschoolFG_yrLevel'];
        $schYear = $_SESSION[$_GET['module'].'PreschoolFG_schYear'];
        $secID   = $_SESSION[$_GET['module'].'PreschoolFG_secID'];
    }
    ...
    if (!isset($_GET['semCode']) && !isset($_SESSION[$_GET['module'].'Preschool_semCode'])) {
        // get the default semester
        $semCode = $config->getConfig('Semester');
    }
    
    // set session variables
    $_SESSION[$_GET['module'].'PreschoolFG_idno']      = $idno;
    $_SESSION[$_GET['module'].'PreschoolFG_lname']     = $lname;
    $_SESSION[$_GET['module'].'PreschoolFG_fname']     = $fname;
    $_SESSION[$_GET['module'].'PreschoolFG_mname']     = $mname;
    $_SESSION[$_GET['module'].'PreschoolFG_yrLevel']   = $yrLevel;
    $_SESSION[$_GET['module'].'PreschoolFG_schYear']   = $schYear;
    $_SESSION[$_GET['module'].'PreschoolFG_secID']     = $secID;
    ...
    $main_url="index.php?module=Grades&action=listEnrollmentsPreschool&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel&schYear=$schYear&semCode=$semCode&secID=$secID";
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/listEnrollmentsPreschool.tpl');
} else {
...
{
    get_data="schYear=" + $('schYear').value + "&yrLevel=" + $('yrLevel').value + "&action=getsectionspreschool2";
