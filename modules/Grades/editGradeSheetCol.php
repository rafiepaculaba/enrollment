...
$accessCode = $access->getAccessCode("Edit Col Grade");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$sugar_smarty->assign('instructor', $gs->profName);
    ...
    $fields['enrollment_details.pregrade'] = "";
    $fields['enrollment_details.mgrade'] = "";
    $fields['enrollment_details.prefigrade'] = "";
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/editGradeSheetCol.tpl');
} else {
...
function getSchedules()
{
	...
	$('students').innerHTML = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>	<tr height="20">	    <td scope="col" class="listViewThS1" width="2%" nowrap>&nbsp;</td>	    <td scope="col" class="listViewThS1" width="10%" nowrap>Grade</td>		<td scope="col" class="listViewThS1" width="15%" nowrap>ID No.</td>		<td scope="col" class="listViewThS1" width="45%" nowrap>Student Name</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Course</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Year</td>	</tr></tbody></table>';
...
function getSubject()
{
   if (trim($('schedID').value)!="") {
    	...
    	$('students').innerHTML = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>	<tr height="20">	    <td scope="col" class="listViewThS1" width="2%" nowrap>&nbsp;</td>	    <td scope="col" class="listViewThS1" width="5%" nowrap>Prelim</td>	    <td scope="col" class="listViewThS1" width="5%" nowrap>Midterm</td>	    <td scope="col" class="listViewThS1" width="5%" nowrap>Pre-Final</td>	    <td scope="col" class="listViewThS1" width="5%" nowrap>Final</td>		<td scope="col" class="listViewThS1" width="15%" nowrap>ID No.</td>		<td scope="col" class="listViewThS1" width="40%" nowrap>Student Name</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Course</td>		<td scope="col" class="listViewThS1" width="10%" nowrap>Year</td>	</tr></tbody></table>';
    }
}
