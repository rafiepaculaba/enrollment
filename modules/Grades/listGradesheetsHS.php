...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $gsID      = $_SESSION[$_GET['module'].'HS_gsID'];
	...
	if ($user->groupID==7) {
	    ...
	    $where[0]['groupID']="=7";  // assuming the groupID 7 is high school teacher
    ...
    $_SESSION[$_GET['module'].'HS_gsID']        = $gsID;
    ...
    $main_url="index.php?module=Grades&action=listGradesheetsHS&gsID=$gsID&schedCode=$schedCode&subjCode=$subjCode&profID=$profID&schYear=$schYear&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/listGradesheetsHS.tpl');
} else {
