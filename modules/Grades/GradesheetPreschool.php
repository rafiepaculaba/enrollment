...
/**
 * Edited
 * Filename: GradesheetPreschool.php
 * Date: 	 June 27, 2008
 * 
...
class GradeSheet extends Database 
{
	 ...
	 * @return array recordset
	 */
	function retrieveAllGradeSheetsAssociated($where='',$orderby='subjects.subjCode', $sorting='ASC', $offset=0, $limit='')
	{
		// building an insert query
		$tables[]="grade_sheets";
		$tables[]="subjects";
	 ...
	 * @return bool 
	 */
	function isExist($schYear, $schedID, $profID)
	{
	    if ($schYear && $schedID && $profID) {
    	    // setting conditions
	...
	function getLastID($schYear, $schedID, $profID)
	{
	    if ($schYear && $schedID && $profID) {
    	    // setting conditions
    	    $conds[]['schYear'] = " = '$schYear' AND ";
