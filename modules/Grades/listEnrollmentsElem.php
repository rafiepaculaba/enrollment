...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $idno   = $_SESSION[$_GET['module'].'ElemFG_idno'];
        $lname  = $_SESSION[$_GET['module'].'ElemFG_lname'];
        $fname  = $_SESSION[$_GET['module'].'ElemFG_fname'];
        $mname  = $_SESSION[$_GET['module'].'ElemFG_mname'];
        $yrLevel = $_SESSION[$_GET['module'].'ElemFG_yrLevel'];
        $schYear = $_SESSION[$_GET['module'].'ElemFG_schYear'];
        $secID   = $_SESSION[$_GET['module'].'ElemFG_secID'];
    }
    ...
    if (!isset($_GET['semCode']) && !isset($_SESSION[$_GET['module'].'Elem_semCode'])) {
        // get the default semester
        $semCode = $config->getConfig('Semester');
    }
    
    // set session variables
    $_SESSION[$_GET['module'].'ElemFG_idno']      = $idno;
    $_SESSION[$_GET['module'].'ElemFG_lname']     = $lname;
    $_SESSION[$_GET['module'].'ElemFG_fname']     = $fname;
    $_SESSION[$_GET['module'].'ElemFG_mname']     = $mname;
    $_SESSION[$_GET['module'].'ElemFG_yrLevel']   = $yrLevel;
    $_SESSION[$_GET['module'].'ElemFG_schYear']   = $schYear;
    $_SESSION[$_GET['module'].'ElemFG_secID']     = $secID;
    ...
    $main_url="index.php?module=Grades&action=listEnrollmentsElem&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel&schYear=$schYear&semCode=$semCode&secID=$secID";
    ...
    echo $sugar_smarty->fetch('modules/Grades/templates/listEnrollmentsElem.tpl');
} else {
...
{
    get_data="schYear=" + $('schYear').value + "&yrLevel=" + $('yrLevel').value + "&action=getsectionselem2";
