<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Grades&action=listEnrollmentsHS');" />
    
	<input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Grades&action=printStudentGradeHS&enID={$enID}&sugar_body_only=1');" />
