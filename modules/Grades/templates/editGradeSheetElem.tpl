<form name="frmGradesheet" id="frmGradesheet" method="post" action="index.php?module=Grades&action=saveGradesheetElem">
<p>
...
<table border="0" width="100%">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Grades&action=viewGradeSheetElem&gsID={$gsID}')" />
    </td>
  </tr>
</table>  
...
<tr><td>
    ...
    <tr>
        <th class="tabDetailViewDF" colspan="5" align="left"><h4 class="tabDetailViewDL">Edit Elementary Grade Sheet</h4></th>
    </tr>
    <tr>
