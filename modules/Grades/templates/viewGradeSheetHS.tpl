...
<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Grades&action=listGradesheetsHS');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdEdit" type="button" id="cmdEdit" value="Edit" onclick="redirect('index.php?module=Grades&action=editGradeSheetHS&gsID={$gsID}');" />
    {/if}
...
<tr><td>
    ...
    <tr>
        <th class="tabDetailViewDF" colspan="5" align="left"><h4 class="tabDetailViewDL">High School Grade Sheet: ({$status})</h4></th>
    </tr>
    <tr>
