...
//    $allStudents = $stud->retrieveAllStudents($conds);
    ...
    $main_url="index.php?module=Credited&action=listStudents&idno=$idno&lname=$lname&sugar_body_only=1";
    ...
    echo $sugar_smarty->fetch('modules/Credited/templates/listStudents.tpl');
} else {
