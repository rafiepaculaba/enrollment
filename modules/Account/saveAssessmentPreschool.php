...
echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME'], $mod_strings['LBL_MODULE_TITLE_ASSESSMENT_PRESCHOOL'], false);
echo "\n</p>\n";
global $theme;
...
setTimeout("redirect('index.php?module=Account&action=viewAssessmentPreschool&assID=<?php echo $assID; ?>')",3000);
</script>