...
$accessCode = $access->getAccessCode("View HS Assessment");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ( $assID ) {
        ...
        if ( $assessment->schYear==$config->getConfig('School Year') ) {
	        $accessCode = $access->getAccessCode("Edit HS Assessment");
	        $sugar_smarty->assign('hasEdit', $access->check_access($current_user->id, $accessCode) );
        }
        
        echo $sugar_smarty->fetch('modules/Account/templates/viewAssessmentHS.tpl');
	} else {
