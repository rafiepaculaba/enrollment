...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Account&action=listAssessmentsHS');" />
    
	{if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Account&action=editAssessmentHS&assID={$assID}');" />
    {/if}
    
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Account&action=printAssessmentHS&assID={$assID}&sugar_body_only=1');" />    
  </tr>
</table>  
