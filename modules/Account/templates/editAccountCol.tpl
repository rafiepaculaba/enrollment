...
<!--        <td class="dataLabel">&nbsp;</td>-->
        <td colspan="4">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                {if $lab_fees neq ""}
                <tr><th class="dataLabel" colspan="4" align="left"><h4 class="dataLabel">Laboratory:</h4></th></tr>
                    {section name=i loop=$lab_fees}
                    <tr>
                        <td class="dataLabel" width="30%"><slot>&nbsp;&nbsp;&nbsp;&nbsp;{$lab_fees[i].particular} </slot></td>
                        <td class="dataField" width="70%">
                        <slot> <input type="text" name="labf_{$lab_fees[i].accDetailID}" id="labf_{$lab_fees[i].accDetailID}" value="{$lab_fees[i].amount}" size="" onkeypress="return keyRestrict(event, 2);" onchange="lab_{$lab_fees[i].accDetailID}();" /> </slot>
                        </td>
                    </tr>
                    {/section}
                {/if}
