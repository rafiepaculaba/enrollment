...
<!--dummy form-->
<form name="frmDummy" id="frmDummy" method="post" action="index.php?module=Account&action=viewAccountElem&accID={$accID}">
</form>

<p>
<ul class="tablist">
<li class="active" id="tab_li_Student_info">
<a class="current" id="tab_link_Student_info" href="index.php?module=Account&action=viewAccountElem&accID={$accID}">Account</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Account&action=listAccountElemLogs&accID={$accID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Account&action=listAccountsElem');" />
    
	{if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Account&action=editAccountElem&accID={$accID}');" />
    {/if}
    
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUpPrint('index.php?module=Account&action=printAccountElem&accID={$accID}&sugar_body_only=1');" />    
  </tr>
</table>  
        ...
        <td colspan="4">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
               ...
               {if $oldBalance gt 0}
                ...
                <tr><th class="tabDetailViewDL" colspan="4" align="left"><h4 class="tabDetailViewDL">Additional Fees:  <input type="button" class="button" name="cmdless" value=" + " onclick="popUp('index.php?module=Account&action=adjustmentAccountElem&accID={$accID}&feeType=Add&sugar_body_only=1');" /> </h4></th></tr>
                ...
                <tr><th class="tabDetailViewDL" colspan="4" align="left"><h4 class="tabDetailViewDL">Less Adjustments:  <input type="button" class="button" name="cmdless" value=" + " onclick="popUp('index.php?module=Account&action=adjustmentAccountElem&accID={$accID}&feeType=Less&sugar_body_only=1');" /> </h4></th></tr>
