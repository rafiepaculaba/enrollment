...
<a id="tab_link_Student_info" href="index.php?module=Account&action=viewAccountHS&accID={$accID}">Account</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Account&action=listAccountHSLogs&accID={$accID}">View Logs</a>
</li>	
</ul>
</p>
