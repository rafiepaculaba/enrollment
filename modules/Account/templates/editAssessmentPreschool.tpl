<form name="frmAssessment" id="frmAssessment" method="post" action="index.php?module=Account&action=saveAssessmentPreschool">
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Account&action=viewAssessmentPreschool&assID={$assID}')" />
    </td>
