...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Account&action=listAssessmentsCol');" />
    
	{if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Account&action=editAssessmentCol&assID={$assID}');" />
    {/if}
    
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Account&action=printAssessmentCol&assID={$assID}&sugar_body_only=1');" />    
  </tr>
</table>  
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td class="tabDetailViewDF" width="35%"><slot>{if $semCode eq 1} 1st {elseif $semCode eq 2} 2nd {else} Summer {/if}&nbsp;</slot></td>
    </tr>
    <tr>
...
<!--        <td class="tabDetailViewDL">&nbsp;</td>-->
        <td colspan="4">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td class="tabDetailViewDL" width="200"><slot>Old Balance </slot></td>
                ...
                <tr>
                    <td class="tabDetailViewDL" width="200"><slot>Tuition/Computer Subj </slot></td>
                ...
                <tr>
                    ...
                    <td class="tabDetailViewDF" align="right"><slot><b>{$ttlPayment|number_format:2}</b></slot></td>
                    <td class="tabDetailViewDL">&nbsp;</td>
                </tr>
                ...
                <tr><th class="tabDetailViewDL" colspan="4" align="left"><h4 class="tabDetailViewDL">Due for {$term}:</h4></th></tr>
                <tr>
