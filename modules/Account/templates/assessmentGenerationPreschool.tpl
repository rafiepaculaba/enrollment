<form name="frmAssessment" id="frmAssessment" method="post" action="index.php?module=Account&action=generateAssessmentPreschool" onsubmit="return check_form('frmAssessment');">
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="10" align="left"><h4 class="dataLabel">Generate Preschool Assessments</h4></th>
    </tr>
    <tr>
