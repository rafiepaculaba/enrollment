<form name="frmAccount" id="frmAccount" method="post" action="index.php?module=Account&action=saveAccountPreschool" onsubmit="return check_form('frmAccount')">
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Account&action=viewAccountPreschool&accID={$accID}')" />
    </td>
