...
<!--dummy form-->
<form name="frmDummy" id="frmDummy" method="post" action="index.php?module=Account&action=viewAccountPreschool&accID={$accID}">
</form>

<p>
<ul class="tablist">
<li class="active" id="tab_li_Student_info">
<a class="current" id="tab_link_Student_info" href="index.php?module=Account&action=viewAccountPreschool&accID={$accID}">Account</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Account&action=listAccountPreschoolLogs&accID={$accID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Account&action=listAccountsPreschool');" />
    
	{if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Account&action=editAccountPreschool&accID={$accID}');" />
    {/if}
    
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUpPrint('index.php?module=Account&action=printAccountPreschool&accID={$accID}&sugar_body_only=1');" />    
  </tr>
</table>  
...
<!--        <td class="tabDetailViewDL">&nbsp;</td>-->
        <td colspan="4">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
	           ...
	           {if $oldBalance gt 0}
	                <tr>
	                    <td class="tabDetailViewDL" width="250"><slot>Old Balance </slot></td>
                ...
                {if $fees neq ""}
                    ...
                    {if $fees[i].particular eq "Miscellaneous"}
						<tr>
	                        <td class="tabDetailViewDL" width="250"><slot>{$fees[i].particular} </slot></td>
                ...
                <tr><th class="tabDetailViewDL" colspan="4" align="left"><h4 class="tabDetailViewDL">Additional Fees:  <input type="button" class="button" name="cmdless" value=" + " onclick="popUp('index.php?module=Account&action=adjustmentAccountPreschool&accID={$accID}&feeType=Add&sugar_body_only=1');" /> </h4></th></tr>
                {if $add_adjustments neq ""}
                    {section name=i loop=$add_adjustments}
                    <tr>
                        <td class="tabDetailViewDL"><slot>{$add_adjustments[i].particular} </slot></td>
                ...
                <tr><th class="tabDetailViewDL" colspan="4" align="left"><h4 class="tabDetailViewDL">Less Adjustments:  <input type="button" class="button" name="cmdless" value=" + " onclick="popUp('index.php?module=Account&action=adjustmentAccountPreschool&accID={$accID}&feeType=Less&sugar_body_only=1');" /> </h4></th></tr>
                {if $less_adjustments neq ""}
                    {section name=i loop=$less_adjustments}
                    <tr>
                        <td class="tabDetailViewDL"><slot>{$less_adjustments[i].particular} </slot></td>
                ...
                <tr>
                    <td class="tabDetailViewDL" width="250"><slot>Total Fees (Php)</slot></td>
                ...
                <tr>
                    <td class="tabDetailViewDL"><slot>Total Payment (Php)</slot></td>
                ...
                <tr>
                    <td class="tabDetailViewDL"><slot>Balance (Php)</slot></td>
