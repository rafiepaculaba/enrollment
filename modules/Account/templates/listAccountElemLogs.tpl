...
<a id="tab_link_Student_info" href="index.php?module=Account&action=viewAccountElem&accID={$accID}">Account</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Account&action=listAccountElemLogs&accID={$accID}">View Logs</a>
</li>	
</ul>
</p>
