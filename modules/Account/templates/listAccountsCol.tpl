	...
	{if $list neq ""}
    	...
    	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Account&action=viewAccountCol&accID={$list[i].accID}" class="listViewTdLinkS1">{$list[i].idno}</a></span></td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Account&action=viewAccountCol&accID={$list[i].accID}" class="listViewTdLinkS1">{$list[i].lname}</a></span></td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Account&action=viewAccountCol&accID={$list[i].accID}" class="listViewTdLinkS1">{$list[i].fname}</a></span></td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Account&action=viewAccountCol&accID={$list[i].accID}" class="listViewTdLinkS1">{$list[i].mname}</a></span></td>
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><img src="themes/Sugar/images/AccountReports.gif" border="0" onclick="popUp('index.php?module=Account&action=statementReportCol&accID={$list[i].accID}&schYear={$list[i].schYear}&semCode={$list[i].semCode}&lname={$list[i].lname}&fname={$list[i].fname}&mname={$list[i].mname}&courseCode={$list[i].courseCode}&yrLevel={$list[i].yrLevel}&sugar_body_only=1');"><span></td>	
