<form name="frmAssessment" id="frmAssessment" method="post" action="index.php?module=Account&action=printBulkAssessmentCol">
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="10" align="left"><h4 class="dataLabel">Printing Bulk College Assessments</h4></th>
    </tr>
    <tr>
