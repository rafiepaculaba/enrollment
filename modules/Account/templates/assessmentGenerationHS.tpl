<form name="frmAssessment" id="frmAssessment" method="post" action="index.php?module=Account&action=generateAssessmentHS" onsubmit="return check_form('frmAssessment');">
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="10" align="left"><h4 class="dataLabel">Generate High School Assessments</h4></th>
    </tr>
    <tr>
