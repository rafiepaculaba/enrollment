...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $idno   = $_SESSION[$_GET['module'].'HSAcc_idno'];
        $lname  = $_SESSION[$_GET['module'].'HSAcc_lname'];
        $fname  = $_SESSION[$_GET['module'].'HSAcc_fname'];
        $mname  = $_SESSION[$_GET['module'].'HSAcc_mname'];
        $yrLevel  = $_SESSION[$_GET['module'].'HSAcc_yrLevel'];
        $schYear  = $_SESSION[$_GET['module'].'HSAcc_schYear'];
    }
    
    if (!isset($_GET['schYear']) && !isset($_SESSION[$_GET['module'].'HSAcc_schYear'])) {
        // get the default schYear
        $schYear = $config->getConfig('School Year');
    }
    
    // set session variables
    $_SESSION[$_GET['module'].'HSAcc_idno']    = $idno;
    $_SESSION[$_GET['module'].'HSAcc_lname']   = $lname;
    $_SESSION[$_GET['module'].'HSAcc_fname']   = $fname;
    $_SESSION[$_GET['module'].'HSAcc_mname']   = $mname;
    $_SESSION[$_GET['module'].'HSAcc_yrLevel'] = $yrLevel;
    $_SESSION[$_GET['module'].'HSAcc_schYear'] = $schYear;
...
//    $allAccounts = $account->retrieveAllAccountsAssociation($conds);
    ...
    $main_url="index.php?module=Account&action=listAccountsHS&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel&schYear=$schYear";
    ...
    echo $sugar_smarty->fetch('modules/Account/templates/listAccountsHS.tpl');
} else {
