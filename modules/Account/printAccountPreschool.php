...
if ( $accID ) {
	...
	if ($student->yrLevel=='S') {
	   $sugar_smarty->assign('yrLevel', 'Special Grade' );
	} else {
	   $sugar_smarty->assign('yrLevel', 'Grade '.$student->yrLevel );
	}
	...
	echo $sugar_smarty->fetch('modules/Account/templates/printAccountPreschool.tpl');
} else {
