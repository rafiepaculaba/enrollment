...
$accessCode = $access->getAccessCode("View Elem Assessment");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ( $assID ) {
        ...
        if ( $assessment->schYear==$config->getConfig('School Year') ) {
	        $accessCode = $access->getAccessCode("Edit Elem Assessment");
	        $sugar_smarty->assign('hasEdit', $access->check_access($current_user->id, $accessCode) );
        }
        
        echo $sugar_smarty->fetch('modules/Account/templates/viewAssessmentElem.tpl');
	} else {
