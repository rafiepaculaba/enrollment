...
$output .= '        </td>';
$output .= '    </tr>';
$output .= '    <tr><th  colspan="4" align="center"><br><b><u>Admission Slip</u></b> <br><br></th></tr>';
$output .= '    <tr>';
...
$output .= '            	<tr height="20">';
$output .= '            		<td scope="col" class="listViewThS1" nowrap><b>Subject</b></td>';
$output .= '            		<td scope="col" class="listViewThS1" nowrap ><b>Description</b></td>';
$output .= '            		<td scope="col" class="listViewThS1" nowrap align="center"><b>Units</b></td>';
$output .= '            		<td scope="col" class="listViewThS1" nowrap ><b>Instructor</b></td>';
$output .= '            		<td scope="col" class="listViewThS1" nowrap ><b>'.$term.'</b></td>';
$output .= '            	</tr>';
...
if ($data_subjs) {
    foreach ($data_subjs as $subj) {
        ...
        $output .= '                		<td>'.$subj['descTitle'].'</td>';
        $output .= '                		<td align="center">'.$subj['units'].'</td>';
        $output .= '                		<td>'.$subj['profName'].'</td>';
        $output .= '                		<td><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></u></td>';
        $output .= '                	</tr>';
    }
}
