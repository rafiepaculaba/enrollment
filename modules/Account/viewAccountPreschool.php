...
$accessCode = $access->getAccessCode("View Preschool Account");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ( $accID ) {
        ...
        if ( $account->schYear==$config->getConfig('School Year') ) {
	        $accessCode = $access->getAccessCode("Edit Preschool Account");
	        $sugar_smarty->assign('hasEdit', $access->check_access($current_user->id, $accessCode) );
        }
        
    	echo $sugar_smarty->fetch('modules/Account/templates/viewAccountPreschool.tpl');
	} else {
