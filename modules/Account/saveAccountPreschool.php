...
require_once('modules/Account/AccountPreschoolLog.php');

echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME'], $mod_strings['LBL_MODULE_TITLE_ACCT_PRESCHOOL'], false);
echo "\n</p>\n";
global $theme;
...
setTimeout("redirect('index.php?module=Account&action=viewAccountPreschool&accID=<?php echo $account->accID; ?>')",3000);
</script>