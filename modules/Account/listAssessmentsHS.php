...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $idno   = $_SESSION[$_GET['module'].'HSAss_idno'];
        $lname  = $_SESSION[$_GET['module'].'HSAss_lname'];
        $fname  = $_SESSION[$_GET['module'].'HSAss_fname'];
        $mname  = $_SESSION[$_GET['module'].'HSAss_mname'];
        $yrLevel  = $_SESSION[$_GET['module'].'HSAss_yrLevel'];
        $schYear  = $_SESSION[$_GET['module'].'HSAss_schYear'];
        $term     = $_SESSION[$_GET['module'].'HSAss_term'];
    }
    
    if (!isset($_GET['schYear']) && !isset($_SESSION[$_GET['module'].'HSAss_schYear'])) {
        // get the default schYear
        $schYear = $config->getConfig('School Year');
    }
    
    // set session variables
    $_SESSION[$_GET['module'].'HSAss_idno']    = $idno;
    $_SESSION[$_GET['module'].'HSAss_lname']   = $lname;
    $_SESSION[$_GET['module'].'HSAss_fname']   = $fname;
    $_SESSION[$_GET['module'].'HSAss_mname']   = $mname;
    $_SESSION[$_GET['module'].'HSAss_yrLevel'] = $yrLevel;
    $_SESSION[$_GET['module'].'HSAss_schYear'] = $schYear;
    $_SESSION[$_GET['module'].'HSAss_term']    = $term;
...
//    $allAssessments = $assessment->retrieveAllAssessmentsAssociated($conds);
    ...
    $main_url="index.php?module=Account&action=listAssessmentsHS&idno=$idno&lname=$lname&fname=$fname&mname=$mname&term=$term&schYear=$schYear&yrLevel=$yrLevel";
    ...
    echo $sugar_smarty->fetch('modules/Account/templates/listAssessmentsHS.tpl');
} else {
