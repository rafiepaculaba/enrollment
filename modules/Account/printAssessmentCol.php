...
if ( $assID ) {
	$sugar_smarty->assign('examDate', $config->getConfig('Exam Date') );
    ...
    $sugar_smarty->assign('ttlUnits', $enrollment->ttlUnits );
	...
	$sugar_smarty->assign('rundate', date("m/d/Y h:i A",time()) );
    	
	echo $sugar_smarty->fetch('modules/Account/templates/printAssessmentCol.tpl');
} else {
