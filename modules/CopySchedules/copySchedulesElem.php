...
$accessCode = $access->getAccessCode("Copy Elem Schedule");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/CopySchedules/templates/copySchedulesElem.tpl');
} else {
...
<script>
addToValidate('frmCopyScheduleElem','fromschYear', '', true, 'From School Year');
addToValidate('frmCopyScheduleElem','toschYear', '', true, 'To School Year');
addToValidate('frmCopyScheduleElem','courseID', '', true, 'Course');
addToValidate('frmCopyScheduleElem','semCode', '', true, 'Semester');
addToValidate('frmCopyScheduleElem','yrLevel', '', true, 'Year Level');
</script>
