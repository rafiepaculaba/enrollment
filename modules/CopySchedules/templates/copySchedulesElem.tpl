<form name="frmCopyScheduleElem" id="frmCopyScheduleElem" method="post" action="index.php?module=CopySchedules&action=copyAllSchedulesElem" onsubmit="return check_form('frmCopyScheduleElem')">
<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="submit" id="cmdSave" value=" Copy Schedules "/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=CopySchedules&action=copySchedulesElem')" />
    </td>
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td>
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		    <tr>
		        <th class="dataField" colspan="4" align="left"><h4 class="dataLabel">Copy Elementary Schedule</h4></th>
		    </tr>
		    <tr>
