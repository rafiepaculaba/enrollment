...
$accessCode = $access->getAccessCode("Copy HS Schedule");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/CopySchedules/templates/copySchedulesHS.tpl');
} else {
...
<script>
addToValidate('frmCopyScheduleHS','fromschYear', '', true, 'From School Year');
addToValidate('frmCopyScheduleHS','toschYear', '', true, 'To School Year');
addToValidate('frmCopyScheduleHS','courseID', '', true, 'Course');
addToValidate('frmCopyScheduleHS','semCode', '', true, 'Semester');
addToValidate('frmCopyScheduleHS','yrLevel', '', true, 'Year Level');
</script>
