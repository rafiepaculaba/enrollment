...
$accessCode = $access->getAccessCode("Copy Preschool Schedule");
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/CopySchedules/templates/copySchedulesPreschool.tpl');
} else {
...
<script>
addToValidate('frmCopySchedulePreschool','fromschYear', '', true, 'From School Year');
addToValidate('frmCopySchedulePreschool','toschYear', '', true, 'To School Year');
addToValidate('frmCopySchedulePreschool','courseID', '', true, 'Course');
addToValidate('frmCopySchedulePreschool','semCode', '', true, 'Semester');
addToValidate('frmCopySchedulePreschool','yrLevel', '', true, 'Year Level');
</script>
