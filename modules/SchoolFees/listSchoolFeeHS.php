...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {	
		...
		$feeID     		= $_SESSION[$_GET['module'].'HS_feeID'];
		$yrLevel     	= $_SESSION[$_GET['module'].'HS_yrLevel'];
		$item     		= $_SESSION[$_GET['module'].'HS_item'];
	}
	...
	$_SESSION[$_GET['module'].'HS_feeID']	= $feeID;
	$_SESSION[$_GET['module'].'HS_yrLevel']	= $yrLevel;
	$_SESSION[$_GET['module'].'HS_item']	= $item;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=SchoolFees&action=listSchoolFeesHS&feeID=$feeID&schYear=$schyear&yrLevel=$yrLevel&item=$item";
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/listSchoolFeeHS.tpl');
} else {
