...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/viewSchoolFeePreschool.tpl');
...
function deleteSchoolFee(feeID)
{
    ...
    if (reply==true)
        redirect('index.php?module=SchoolFees&action=deleteSchoolFeePreschool&feeID='+feeID);
}
</script>