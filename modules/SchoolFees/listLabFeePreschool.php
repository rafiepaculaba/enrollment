...
$accessCode = $access->getAccessCode("List Preschool Lab Fee");
...
//		$total_rec=0;
	...
	$main_url="index.php?module=SchoolFees&action=listLabFeePreschool&schedID=$schedID&schYear=$schYear&schedCode=$schedCode&subjCode=$subjCode";
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/listLabFeePreschool.tpl');
} else {
