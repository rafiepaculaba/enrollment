...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/assignLabFeeElem.tpl');
} else {
...
<script>
addToValidate('frmLabFeeElem','schYear', '', true, 'School Year');
addToValidate('frmLabFeeElem','schedID', '', true, 'Sched Code');
addToValidate('frmLabFeeElem','amount', '', true, 'Amount');
</script>

<script language="javascript">
function saveLabFee()
{
	if (check_form('frmLabFeeElem')) {
		$('frmLabFeeElem').submit();
	}
}
...
function selectSchedule()
{
    ...
    if ($('schYear').value != '') {
        ...
        get_data="schYear=" + $('schYear').value + "&action=selectscheduleelem";
...
{
    if ($('schYear').value != '') {
        get_data="schedID=" + $('schedID').value + "&action=displayscheduleelem";
