...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/createMiscFeeElem.tpl');
} else {
...
function checkDuplicate()
{
    if (check_form('frmMiscFee')) {
        get_data="schYear=" + $('schYear').value + "&yrLevel=" + $('yrLevel').value + "&particular=" + $('particular').value + "&action=checkduplicatemiscelem";
