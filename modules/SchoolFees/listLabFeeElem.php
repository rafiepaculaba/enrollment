...
//		$total_rec=0;
	...
	$main_url="index.php?module=SchoolFees&action=listLabFeeElem&schedID=$schedID&schYear=$schYear&schedCode=$schedCode&subjCode=$subjCode";
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/listLabFeeElem.tpl');
} else {
