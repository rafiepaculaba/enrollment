...
require_once('modules/SchoolFees/MiscFeePreschool.php');
...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {		
		...
		$miscID     	= $_SESSION[$_GET['module'].'Preschool_miscID'];
		$yrLevel     	= $_SESSION[$_GET['module'].'Preschool_yrLevel'];
		$particular		= $_SESSION[$_GET['module'].'Preschool_particular'];
	}
	...
	$_SESSION[$_GET['module'].'Preschool_miscID']		= $miscID;
	$_SESSION[$_GET['module'].'Preschool_yrLevel']	= $yrLevel;
	$_SESSION[$_GET['module'].'Preschool_particular']	= $particular;
	...
	$main_url="index.php?module=SchoolFees&action=listMiscFeePreschool&miscID=$miscID&schYear=$schyear&yrLevel=$yrLevel&particular=$particular";
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/listMiscFeePreschool.tpl');
} else {
