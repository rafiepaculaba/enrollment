...
$accessCode = $access->getAccessCode("View Preschool School Fee");
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete Preschool School Fee");
    $sugar_smarty->assign('hasDelete', $access->check_access($current_user->id, $accessCode) );
	
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/viewMiscFeePreschool.tpl');
...
function deleteMiscFee(miscID)
{
    ...
    if (reply==true)
        redirect('index.php?module=SchoolFees&action=deleteMiscFeePreschool&miscID='+miscID);
}
</script>