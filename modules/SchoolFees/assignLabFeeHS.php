...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/assignLabFeeHS.tpl');
} else {
...
<script>
addToValidate('frmLabFeeHS','schYear', '', true, 'School Year');
addToValidate('frmLabFeeHS','schedID', '', true, 'Sched Code');
addToValidate('frmLabFeeHS','amount', '', true, 'Amount');
</script>
...
function selectSchedule()
{
    ...
    if ($('schYear').value != '') {
        ...
        get_data="schYear=" + $('schYear').value + "&action=selectschedulehs";
...
{
    if ($('schYear').value != '') {
        get_data="schedID=" + $('schedID').value + "&action=displayschedulehs";
