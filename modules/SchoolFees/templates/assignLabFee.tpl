...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=SchoolFees&action=listLabFeeCol')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="4" align="left"><h4 class="dataLabel">Assign Laboratory Fee: College</h4></th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="dataField"><slot>
          <input type="text" name="courseCode" id="courseCode" size="" maxlength=""  readonly/>
        </slot></td>
    ...
    <tr>
        ...
        <td class="dataField"><slot>
          <input type="text" name="curName" id="curName" size="40" maxlength=""  readonly/>
        </slot></td>
    </tr>
    <tr>
