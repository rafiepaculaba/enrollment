<form method="post" name="frmSchoolFee" id="frmSchoolFee" action="index.php?module=SchoolFees&action=saveSchoolFeePreschool&feeID={$feeID}">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Preschool - School Fee</h4></th>
    </tr>
    <tr>
