<form method="post" name="frmSchoolFee" id="frmSchoolFee" action="index.php?module=SchoolFees&action=saveSchoolFeeElem&feeID={$feeID}">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Elementary - School Fee</h4></th>
    </tr>
    <tr>
