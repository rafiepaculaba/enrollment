<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=SchoolFees&action=listMiscFeePreschool');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=SchoolFees&action=editMiscFeePreschool&miscID={$miscID}');" />
    {/if}
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <th class="tabDetailViewDL" colspan="2" align="left"><h4 class="tabDetailViewDL">Pre-school Miscellaneous Fee</h4></th>
    </tr>
    <tr>
