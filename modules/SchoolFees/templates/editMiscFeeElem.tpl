<form method="post" name="frmMiscFee" id="frmMiscFee" action="index.php?module=SchoolFees&action=saveMiscFeeElem&miscID={$miscID}">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Elementary Miscellaneous Fee</h4></th>
    </tr>
    <tr>
