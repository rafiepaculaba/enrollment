<form name="frmMiscFee" id="frmMiscFee" method="post" action="index.php?module=SchoolFees&action=saveMiscFeeCol" >

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="checkDuplicate();"/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=SchoolFees&action=listMiscFeeCol')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Create Miscellaneous Fee: College</h4></th>
    </tr>
    <tr>
