<form method="post" name="frmMiscFee" id="frmMiscFee" action="index.php?module=SchoolFees&action=saveMiscFeeHS&miscID={$miscID}">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit High School Miscellaneous Fee</h4></th>
    </tr>
    <tr>
