<form method="post" name="frmMiscFee" id="frmMiscFee" action="index.php?module=SchoolFees&action=saveMiscFeePreschool&miscID={$miscID}">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Pre-school Miscellaneous Fee</h4></th>
    </tr>
    <tr>
	...
	<tr>
        <td class="dataLabel" width="18%"><slot>Grade </slot></td>
