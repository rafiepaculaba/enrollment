<form name="frmLabFeePreschool" id="frmLabFeePreschool" method="post" action="index.php?module=SchoolFees&action=saveLabFeePreschool" >

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="saveLabFee();"/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=SchoolFees&action=listLabFeePreschool')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="4" align="left"><h4 class="dataLabel">Assign Laboratory Fee: Preschool</h4></th>
    </tr>
    <tr>
