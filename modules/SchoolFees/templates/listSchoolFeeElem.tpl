<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td nowrap="nowrap"><h3><img src="themes/Sugar/images/h3Arrow.gif" border="0" height="11" width="11">&nbsp;School Fee: Elementary</h3></td><td width="100%"><img src="include/images/blank.gif" alt="" height="1" width="1"></td>
	</tr>
</table>
<p>
<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" width="50%" nowrap>Particular </td>
		<td scope="col" class="listViewThS1" width="10%" nowrap>Amount </td>
		<td scope="col" class="listViewThS1" width="10%" nowrap>Apply </td>
	</tr>
	<tr height="20">
	    <form name="frmFilter" id="frmFilter" method="GET" action="index.php?module=SchoolFees&action=listSchoolFeeElem">
	    <input type="hidden" name="module" value="SchoolFees" />
	    <input type="hidden" name="action" value="listSchoolFeeElem" />
	...
	{if $list neq ""}
		...
		<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=SchoolFees&action=viewSchoolFeeElem&feeID={$list[i].feeID}" class="listViewTdLinkS1">{$list[i].feeID}</a></span></td>
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=SchoolFees&action=viewSchoolFeeElem&feeID={$list[i].feeID}" class="listViewTdLinkS1">{$list[i].item}</a></span></td>	
