<form method="post" name="frmSchoolFee" id="frmSchoolFee" action="index.php?module=SchoolFees&action=saveSchoolFeeCol&feeID={$feeID}">
<input type="hidden" name="courseID" id="feeID" value="{$feeID}" />
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit College School Fee</h4></th>
    </tr>
    <tr>
