...
$accessCode = $access->getAccessCode("View Preschool Lab Fee");
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Edit Preschool Lab Fee");
    $sugar_smarty->assign('hasEdit', $access->check_access($current_user->id, $accessCode) );
    
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/viewLabFeePreschool.tpl');
} else {
