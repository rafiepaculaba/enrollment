...
require_once('modules/SchoolFees/MiscFeeElem.php');
...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {		
		...
		$miscID     	= $_SESSION[$_GET['module'].'Elem_miscID'];
		$yrLevel     	= $_SESSION[$_GET['module'].'Elem_yrLevel'];
		$particular		= $_SESSION[$_GET['module'].'Elem_particular'];
	}
	...
	$_SESSION[$_GET['module'].'Elem_miscID']		= $miscID;
	$_SESSION[$_GET['module'].'Elem_yrLevel']	= $yrLevel;
	$_SESSION[$_GET['module'].'Elem_particular']	= $particular;
	...
	$main_url="index.php?module=SchoolFees&action=listMiscFeeElem&miscID=$miscID&schYear=$schyear&yrLevel=$yrLevel&particular=$particular";
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/listMiscFeeElem.tpl');
} else {
