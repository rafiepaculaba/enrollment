...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {		
		...
		$miscID     	= $_SESSION[$_GET['module'].'Col_miscID'];
		$courseID     	= $_SESSION[$_GET['module'].'Col_courseID'];
		$yrLevel     	= $_SESSION[$_GET['module'].'Col_yrLevel'];
		$particular		= $_SESSION[$_GET['module'].'Col_particular'];
	}
	...
	$_SESSION[$_GET['module'].'Col_miscID']		= $miscID;
	$_SESSION[$_GET['module'].'Col_courseID']	= $courseID;
	$_SESSION[$_GET['module'].'Col_yrLevel']	= $yrLevel;
	$_SESSION[$_GET['module'].'Col_particular']	= $particular;
	...
	$main_url="index.php?module=SchoolFees&action=listMiscFeeCol&miscID=$miscID&schYear=$schyear&courseID=$courseID&yrLevel=$yrLevel&particular=$particular";
	...
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/listMiscFeeCol.tpl');
} else {
