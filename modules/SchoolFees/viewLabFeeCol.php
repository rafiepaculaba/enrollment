...
$accessCode = $access->getAccessCode("View Col Lab Fee");
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Edit Col Lab Fee");
    $sugar_smarty->assign('hasEdit', $access->check_access($current_user->id, $accessCode) );
    
	echo $sugar_smarty->fetch('modules/SchoolFees/templates/viewLabFeeCol.tpl');
} else {
