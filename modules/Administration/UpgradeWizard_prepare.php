...
?>
<form action="<?php print( $form_action . "_commit" ); ?>" name="files" method="post"  onSubmit="return handleCommit(<?php print($require_license); ?>);">
<?php
    switch( $mode ){
        case "Install":
...
?>
    ...
    ?>
    <input type=submit value="<?php echo $mod_strings['LBL_ML_COMMIT'];?>" />
