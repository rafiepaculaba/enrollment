...
require_once('modules/Administration/SchoolFeeCol.php');
...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$sugar_smarty->assign('courseCode', $fee->courseCode );
	...
	echo $sugar_smarty->fetch('modules/Administration/templates/viewSchoolFeeCol.tpl');
...
function deleteSchoolFee(feeID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Administration&action=deleteSchoolFeeCol&feeID='+feeID);
}
</script>