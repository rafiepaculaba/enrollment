...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/Administration/templates/viewSchoolFeeElem.tpl');
...
{
    reply=confirm("Do you really want to delete this Fee?");
    
    if (reply==true)
        redirect('index.php?module=Administration&action=deleteSchoolFeeElem&feeID='+feeID);
}
</script>