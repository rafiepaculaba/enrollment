...
require_once('modules/Administration/ChartAccountType.php');
...
if ( isset($_POST['theForm']) ) {
    ...
    $chartaccounttype->parent = $_POST['parentID'];
    $chartaccounttype->name   = $_POST['typeName'];
    
    // new student record
	if (!$chartaccounttype->isExist($chartaccounttype->name)) {
    	if ($chartaccounttype->createRecord()) {
	   ...
	   $msg = "'".$_POST['typeName']."' Type is already exist!";
	   $sugar_smarty->assign('class', 'errorbox');
	}
