...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$main_url="index.php?module=Administration&action=listSchoolFeesHS&feeID=$feeID&schYear=$schyear&yrLevel=$yrLevel&item=$item";
	...
	echo $sugar_smarty->fetch('modules/Administration/templates/listSchoolFeeHS.tpl');
} else {
