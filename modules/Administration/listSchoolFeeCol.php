...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$main_url="index.php?module=Administration&action=listSchoolFeesCol&feeID=$feeID&schYear=$schyear&courseID=$courseID&item=$item";
	...
	echo $sugar_smarty->fetch('modules/Administration/templates/listSchoolFeeCol.tpl');
} else {
