...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$sugar_smarty->assign('courseID', $fee->courseID );
...
$sugar_smarty->assign('listCourse',$listCourse);
	echo $sugar_smarty->fetch('modules/Administration/templates/editSchoolFeeCol.tpl');
} else {
...
addToValidate('frmSchoolFee','item', '', true, 'Item');
