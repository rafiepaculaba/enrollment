...
echo '<p>' .
      get_module_title($mod_strings['LBL_MODULE_NAME'],
                       $mod_strings['LBL_MODULE_TITLE'], false)
      . '</p>';
...
//$admin_option_defs['backup_management']= array($image_path . 'Backups','LBL_BACKUPS_TITLE','LBL_BACKUPS','#');
...
$admin_option_defs['repair']= array($image_path . 'admin_repair2','LBL_UPGRADE_TITLE','LBL_UPGRADE','./index.php?module=Administration&action=Upgrade');
...
//$admin_option_defs['module_loader'] = array($image_path . 'admin_moduleLoad','LBL_MODULE_LOADER_TITLE','LBL_MODULE_LOADER','./index.php?module=Administration&action=UpgradeWizard&view=module');
//$admin_option_defs['currencies_management']= array($image_path . 'Currencies','LBL_MANAGE_CURRENCIES','LBL_CURRENCY','./index.php?module=Currencies&action=index');
...
//users and security.
$admin_option_defs=array();
$admin_option_defs['user_management']= array($image_path . 'admin_userManage','LBL_MANAGE_USERS_TITLE','LBL_MANAGE_USERS','./index.php?module=Users&action=index');
$admin_option_defs['roles_management']= array($image_path . 'admin_roleManage','LBL_MANAGE_ROLES_TITLE','LBL_MANAGE_ROLES','./index.php?module=ACLRoles&action=index');
...
//school fees
//$admin_option_defs=array();
//$admin_option_defs['school_fee_col_config']= array($image_path . 'OpportunityReports','LBL_SCHOOL_FEE_COLLEGE_TITLE','LBL_SCHOOL_FEE_COLLEGE_DESC','./index.php?module=Administration&action=createSchoolFeeCol');
//$admin_option_defs['mass_Email']= array($image_path . 'EmailMan','LBL_MASS_EMAIL_MANAGER_TITLE','LBL_MASS_EMAIL_MANAGER_DESC','./index.php?module=EmailMan&action=index');
//$admin_option_defs['school_fee_hs_config']= array($image_path . 'PriceList','LBL_SCHOOL_FEE_HS_TITLE','LBL_SCHOOL_FEE_HS_DESC','./index.php?module=Administration&action=createSchoolFeeHS');
//$admin_option_defs['school_fee_elem_config']= array($image_path . 'PriceList','LBL_SCHOOL_FEE_ELEM_TITLE','LBL_SCHOOL_FEE_ELEM_DESC','./index.php?module=Administration&action=createSchoolFeeElem');
//$admin_group_header[]=array('LBL_SCHOOLFEE_TITLE','',false,$admin_option_defs);

// school configuration
$admin_option_defs=array();
$admin_option_defs['school_config']= array($image_path . 'admin_config','LBL_SCHOOL_CONFIG_TITLE','LBL_SCHOOL_CONFIG_DESC','./index.php?module=Config&action=index');
$admin_option_defs['copy_schedules']= array($image_path . 'admin_schedulesCopy','LBL_COPY_SCHED_TITLE','LBL_COPY_SCHED_DESC','./index.php?module=CopySchedules&action=copySchedules');
$admin_option_defs['']= array($image_path . 'admin_schedulesCopy','LBL_CHART_OF_ACCOUNTS_TITLE','LBL_CHART_OF_ACCOUNTS_DESC','./index.php?module=Administration&action=listChartOfAccounts');
$admin_group_header[]=array('LBL_SCHOOLCONFIG_TITLE','',false,$admin_option_defs);
