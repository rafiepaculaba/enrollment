...
$accessCode = $access->getAccessCode("View HS Subject");
...
function deleteSubject(subjID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Subjects&action=deleteSubjectHS&subjID='+subjID);
}
</script>