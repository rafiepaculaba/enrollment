<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Subjects&action=listSubjects');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Subjects&action=editSubject&subjID={$subjID}');" />
    {/if}
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td class="tabDetailViewDL"><slot>Computer Subject :</slot></td>
        <td class="tabDetailViewDF"><slot>{$isCompSubj} &nbsp;</slot></td>
    </tr>
</table>
</p>