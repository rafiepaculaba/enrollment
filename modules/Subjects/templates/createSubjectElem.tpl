<form name="frmSubjectElem" id="frmSubjectElem" method="post" action="index.php?module=Subjects&action=saveSubjectElem">

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="checkDuplicateElem();" />
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=Subjects&action=listSubjectsElem')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Create Elementary Subject</h4></th>
    </tr>
    <tr>
