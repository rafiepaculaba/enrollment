...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {	
		...
		$subjCode     	= $_SESSION[$_GET['module'].'Preschool_subjCode'];
		$descTitle     	= $_SESSION[$_GET['module'].'Preschool_descTitle'];
		$yrLevel     	= $_SESSION[$_GET['module'].'Preschool_yrLevel'];
	}

	//set session variables
	$_SESSION[$_GET['module'].'Preschool_subjCode']		= $subjCode;
	$_SESSION[$_GET['module'].'Preschool_descTitle']     = $descTitle;
...
//	$allSubjects = $subj->retrieveAllSubjects($conds);
	...
	$list        = $subj->retrieveAllSubjects($conds,"","",$offset, $limit);
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Subjects&action=listSubjectsPreschool&subjCode=$subjCode&descTitle=$descTitle&yrLevel=$yrLevel";
	...
	echo $sugar_smarty->fetch('modules/Subjects/templates/listSubjectsPreschool.tpl');
} else {
