...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {	
		...
		$descTitle     	= $_SESSION[$_GET['module'].'Elem_descTitle'];
		$yrLevel     	= $_SESSION[$_GET['module'].'Elem_yrLevel'];
	}

	//set session variables
	$_SESSION[$_GET['module'].'Elem_subjCode']		= $subjCode;
	$_SESSION[$_GET['module'].'Elem_descTitle']     = $descTitle;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Subjects&action=listSubjectsElem&subjCode=$subjCode&descTitle=$descTitle&yrLevel=$yrLevel";
	...
	echo $sugar_smarty->fetch('modules/Subjects/templates/listSubjectsElem.tpl');
} else {
