...
$accessCode = $access->getAccessCode("View Elem Subject");
...
function deleteSubject(subjID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Subjects&action=deleteSubjectElem&subjID='+subjID);
}
</script>