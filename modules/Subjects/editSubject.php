...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$sugar_smarty->assign('isCompsubj', $subj->isCompsubj );
	...
	echo $sugar_smarty->fetch('modules/Subjects/templates/editSubject.tpl');
} else {
...
<script>
addToValidate('frmSubject','courseID', '', true, 'Course Code');
