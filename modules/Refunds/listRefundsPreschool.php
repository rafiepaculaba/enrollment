...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$refundID     	= $_SESSION[$_GET['module'].'Preschool_refundID'];		
	...
	$_SESSION[$_GET['module'].'Preschool_refundID']	= $refundID;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Refunds&action=listRefundsPreschool&refundID=$refundID&schYear=$schYear&idno=$idno&lname=$lname&fname=$fname&mname=$mname&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Refunds/templates/listRefundsPreschool.tpl');
} else {
