...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$refundID     	= $_SESSION[$_GET['module'].'Elem_refundID'];		
	...
	$_SESSION[$_GET['module'].'Elem_refundID']	= $refundID;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Refunds&action=listRefundsElem&refundID=$refundID&schYear=$schYear&idno=$idno&lname=$lname&fname=$fname&mname=$mname&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Refunds/templates/listRefundsElem.tpl');
} else {
