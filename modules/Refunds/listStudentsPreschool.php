...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$_SESSION[$_GET['module'].'Prschoolpop_lname']  = $lname;
...
//    $allStudents = $stud->retrieveAllStudents($conds);
    ...
    $main_url="index.php?module=Refunds&action=listStudentsPreschool&idno=$idno&lname=$lname&sugar_body_only=1";
    ...
    echo $sugar_smarty->fetch('modules/Refunds/templates/listStudentsPreschool.tpl');
} else {
