...
<a id="tab_link_Refund_info" href="index.php?module=Refunds&action=viewRefundElem&refundID={$refundID}">Refund Form</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Refunds&action=listRefundElemLogs&refundID={$refundID}">View Logs</a>
</li>	
</ul>
</p>
