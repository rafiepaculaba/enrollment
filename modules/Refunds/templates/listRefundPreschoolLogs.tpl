<p>
<ul class="tablist">
<li id="tab_li_Refund_info">
<a id="tab_link_Refund_info" href="index.php?module=Refunds&action=viewRefundPreschool&refundID={$refundID}">Refund Form</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Refunds&action=listRefundPreschoolLogs&refundID={$refundID}">View Logs</a>
</li>	
</ul>
</p>
