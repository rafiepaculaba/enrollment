<form name="frmRefundElem" id="frmRefundElem" method="post" action="index.php?module=Refunds&action=saveRefundElem" >
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Refunds&action=listRefundsElem')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">New Elementary Refund</h4></th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <input type="button" name="cmdLookup" id="cmdLookup" value="=" onclick="popUp('index.php?module=Refunds&action=listStudentsElem&sugar_body_only=1')" />
        </slot>
        </td>
    </tr>
        <tr>
