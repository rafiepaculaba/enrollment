...
echo $sugar_smarty->fetch('modules/Refunds/templates/createRefundHS.tpl');
...
<script>
addToValidate('frmRefundHS','schYear', '', true, 'School Year');
addToValidate('frmRefundHS','idno', '', true, 'ID No.');
...
function validateAmount()
{
   	if($('idno').value != '' && $('schYear').value != '' && $('amount').value != ''){
		get_data="idno=" + $('idno').value +"&schYear=" + $('schYear').value +"&amount=" + $('amount').value + "&action=checkamountshs";
...
{
    get_data="idno=" + $('idno').value + "&action=displaycompletenamehs";
