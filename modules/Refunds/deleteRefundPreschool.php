...
$access = new AccessChecker();
	$accessCode = $access->getAccessCode("Delete Preschool Refund");
...
setTimeout("redirect('index.php?module=Refunds&action=listRefundsPreschool')", 3000);
</script>