...
$accessCode = $access->getAccessCode("View Elem Refund");
...
function cancelRefund(refundID, accID, amount)
{
    ...
    if (reply==true)
        redirect('index.php?module=Refunds&action=cancelRefundElem&refundID='+refundID+'&accID='+accID+'&amount='+amount);
}
</script>