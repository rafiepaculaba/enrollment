...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/Refunds/templates/editRefundPreschool.tpl');
...
function onSubmit()
{
    get_data="idno=" + $('idno').value +"&schYear=" + $('schYear').value +"&amount=" + $('amount').value +"&balance=" + $('balance').value + "&action=editcheckamountspreschool";
