...
echo $sugar_smarty->fetch('modules/Refunds/templates/createRefund.tpl');
...
<script>
addToValidate('frmRefund','schYear', '', true, 'School Year');
addToValidate('frmRefund','semCode', '', true, 'Semester');
addToValidate('frmRefund','idno', '', true, 'ID No.');
...
{
	if($('idno').value != '' && $('schYear').value != '' && $('semCode').value != '' && $('amount').value != ''){
	    get_data="idno=" + $('idno').value +"&schYear=" + $('schYear').value +"&semCode=" + $('semCode').value+"&amount=" + $('amount').value + "&action=checkamounts";
...
{
    get_data="idno=" + $('idno').value + "&action=displaycompletename";
