...
//    $allStudents = $stud->retrieveAllStudents($conds);
    ...
    $main_url="index.php?module=Refunds&action=listStudentsElem&idno=$idno&lname=$lname&sugar_body_only=1";
    ...
    echo $sugar_smarty->fetch('modules/Refunds/templates/listStudentsElem.tpl');
} else {
