...
<a id="tab_link_Student_info" href="index.php?module=Enrollments&action=viewEnrollmentPreschool&enID={$enID}">Enrollment Form</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Enrollments&action=listEnrollmentPreschoolLogs&enID={$enID}">View Logs</a>
</li>	
</ul>
</p>
	...
	{if $logs neq ""}
    	...
    	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" valign="top">{$logs[i].docType}</td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" valign="top">{$logs[i].subjects}</td>
