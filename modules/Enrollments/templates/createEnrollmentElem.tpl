<form name="frmEnrollment" id="frmEnrollment" method="post" action="index.php?module=Enrollments&action=saveEnrollmentElem" >
<p>
...
<table border="0" width="100%">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Enrollments&action=listEnrollmentsElem')" />
    </td>
...
<tr><td>
    ...
    <tr>
        ...
        <input type="button" name="cmdLookup" id="cmdLookup" value="=" onclick="popUp('index.php?module=Enrollments&action=listStudentsElem&sugar_body_only=1')" />
        </slot>  </td>
    </tr>
    ...
    <tr>
        <td class="dataLabel" height="50" valign="bottom"><slot>Grade <span class="required">*</span></slot> </td>
