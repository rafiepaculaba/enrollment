...
<a class="current" id="tab_link_Student_info" href="index.php?module=Enrollments&action=viewEnrollmentPreschool&enID={$enID}">Enrollment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Enrollments&action=listEnrollmentPreschoolLogs&enID={$enID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Enrollments&action=listEnrollmentsPreschool');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Enrollments&action=editEnrollmentPreschool&enID={$enID}');" />
    {/if}
    ...
    {/if}
     ...
     {if $hasPrint eq 1 }
	<input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Enrollments&action=printStudyLoadPreschool&enID={$enID}&sugar_body_only=1');" />
    {/if}
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td class="tabDetailViewDL"><slot>Level :</slot></td>
