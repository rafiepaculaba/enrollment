...
<a id="tab_link_Student_info" href="index.php?module=Enrollments&action=viewEnrollmentHS&enID={$enID}">Enrollment Form</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Enrollments&action=listEnrollmentHSLogs&enID={$enID}">View Logs</a>
</li>	
</ul>
</p>
