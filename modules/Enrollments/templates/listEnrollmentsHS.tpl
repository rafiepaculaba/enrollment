<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td nowrap="nowrap"><h3><img src="themes/Sugar/images/h3Arrow.gif" border="0" height="11" width="11">&nbsp;High School Enrollments</h3></td><td width="100%"><img src="include/images/blank.gif" alt="" height="1" width="1"></td>
	</tr>
</table>
<p>
<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>
	...
	<tr height="20">
	    ...
	    <input type="hidden" name="action" value="listEnrollmentsHS" />
	...
	{if $list neq ""}
    	...
    	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Enrollments&action=viewEnrollmentHS&enID={$list[i].enID}" class="listViewTdLinkS1">{$list[i].idno}</a></span></td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Enrollments&action=viewEnrollmentHS&enID={$list[i].enID}" class="listViewTdLinkS1">{$list[i].lname}</a></span></td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Enrollments&action=viewEnrollmentHS&enID={$list[i].enID}" class="listViewTdLinkS1">{$list[i].fname}</a></span></td>
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
    		align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Enrollments&action=viewEnrollmentHS&enID={$list[i].enID}" class="listViewTdLinkS1">{$list[i].mname}</a></span></td>
