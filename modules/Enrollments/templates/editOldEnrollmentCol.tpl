...
<input type="hidden" id="oenID" name="oenID" value="{$oenID}" />
...
<table border="0" width="100%">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Enrollments&action=viewOldEnrollmentCol&oenID={$oenID}')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Old Enrollment</h4></th>
    </tr>
    <tr>
...
<tbody>
	...
	<td scope="row" 
        ...
        {/if}
        align="left" bgcolor="#fdfdfd" valign="top"><img src="themes/Sugar/images/delete_inline.gif" alt="Remove" onclick="removeSubject('{$list[i].subjID}');" /></td>
