...
<a class="current" id="tab_link_Student_info" href="index.php?module=Enrollments&action=viewEnrollmentElem&enID={$enID}">Enrollment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Enrollments&action=listEnrollmentElemLogs&enID={$enID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Enrollments&action=listEnrollmentsElem');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Enrollments&action=editEnrollmentElem&enID={$enID}');" />
    {/if}
    ...
    {/if}
     ...
     {if $hasPrint eq 1 }
	<input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Enrollments&action=printStudyLoadElem&enID={$enID}&sugar_body_only=1');" />
    {/if}
