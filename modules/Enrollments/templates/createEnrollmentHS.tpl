<form name="frmEnrollment" id="frmEnrollment" method="post" action="index.php?module=Enrollments&action=saveEnrollmentHS" >
<p>
...
<table border="0" width="100%">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Enrollments&action=listEnrollmentsHS')" />
    </td>
...
<tr><td>
    ...
    <tr>
        ...
        <input type="text" name="idno" id="idno" size="19" maxlength="15"  onkeypress="return keyRestrict2(event, 14,'onCheckEnrollment');"  onchange="checkPrevID();" /> 
        <input type="button" name="cmdLookup" id="cmdLookup" value="=" onclick="popUp('index.php?module=Enrollments&action=listStudentsHS&sugar_body_only=1')" />
        </slot>  </td>
    </tr>
    ...
    <tr>
        <td class="dataLabel" height="50" valign="bottom"><slot>Year Level <span class="required">*</span></slot> </td>
