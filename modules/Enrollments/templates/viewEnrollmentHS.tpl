...
<a class="current" id="tab_link_Student_info" href="index.php?module=Enrollments&action=viewEnrollmentHS&enID={$enID}">Enrollment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Enrollments&action=listEnrollmentHSLogs&enID={$enID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
	<input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Enrollments&action=listEnrollmentsHS');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Enrollments&action=editEnrollmentHS&enID={$enID}');" />
    {/if}
    ...
    {if $hasPrint eq 1 }
	<input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Enrollments&action=printStudyLoadHS&enID={$enID}&sugar_body_only=1');" />
    {/if}
