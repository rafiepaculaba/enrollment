...
<table border="0" width="100%">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Enrollments&action=viewEnrollmentCol&enID={$enID}')" />
    </td>
...
<tr><td>
    ...
    <tr>
        ...
        <tr>
        <td>{$SCHOOLYEAR}</td>
        <td class="dataLabel" valign="top">Semester  </td>
        <td>{$SEMESTERS}</td>
        </tr>
        </table>        
        </slot></td>
    ...
    <tr>
        <td class="dataLabel" height="50" valign="bottom"><slot>Course <span class="required">*</span></slot> </td>
...
<tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" width="10%" nowrap>Couse</td>
