<form name="frmEnrollment" id="frmEnrollment" method="post" action="index.php?module=Enrollments&action=saveEnrollmentCol" >
<p>
...
<input type="hidden" id="totalunits" name="totalunits" value="" />

<table border="0" width="100%">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="saveEnrollment();" />
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Enrollments&action=listEnrollmentsCol')" />
    </td>
...
<tr><td>
    ...
    <tr>
        ...
        <select name="courseID" id="courseID" onchange="onDepartment();" >
        <option value="">-------------------</option>
        ...
        <td class="dataLabel" valign="bottom"><slot>Section / Block </slot></td>
        <td class="dataField" valign="bottom">
        <slot>
