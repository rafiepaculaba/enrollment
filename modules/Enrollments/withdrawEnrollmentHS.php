...
//		    	}
//                
//                $account->totalFee -= ($fees + $add_adjustments);
//                $account->balance  -= ($fees + $add_adjustments);
//                
...
setTimeout("redirect('index.php?module=Enrollments&action=viewEnrollmentHS&enID=<?php echo $enID; ?>')", 3000);
</script>