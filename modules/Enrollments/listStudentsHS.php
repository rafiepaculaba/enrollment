...
global $current_user;
    ...
    if ($_GET['cmdFilter']) {
        ...
        $fname  = $_SESSION[$_GET['module'].'HSpop_fname'];
        $mname  = $_SESSION[$_GET['module'].'HSpop_mname'];
        $yrLevel  = $_SESSION[$_GET['module'].'HSpop_yrLevel'];
    }
    ...
    $main_url="index.php?module=Enrollments&action=listStudentsHS&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel";
    ...
    echo $sugar_smarty->fetch('modules/Enrollments/templates/listStudentsHS.tpl');
?>
