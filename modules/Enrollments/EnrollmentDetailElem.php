...
//    		    $query = "select firstgrade, secondgrade, thirdgrade, fourthgrade, fgrade from form137 where endID='".$row['endID']."' limit 1";
        		...
        		if (count($records2)) {
        		   $data[$ctr]['firstgrade']  = $records2[0]['firstgrade'];
        		   $data[$ctr]['secondgrade'] = $records2[0]['secondgrade'];
        		   $data[$ctr]['thirdgrade']  = $records2[0]['thirdgrade'];
        		   $data[$ctr]['fourthgrade'] = $records2[0]['fourthgrade'];
        		   $data[$ctr]['fgrade']      = $records2[0]['fgrade'];
        		} else { 
        		   $data[$ctr]['firstgrade']  = "";
        		   $data[$ctr]['secondgrade'] = "";
        		   $data[$ctr]['thirdgrade']  = "";
        		   $data[$ctr]['fourthgrade'] = "";
        		   $data[$ctr]['fgrade']      = "";
        		}
