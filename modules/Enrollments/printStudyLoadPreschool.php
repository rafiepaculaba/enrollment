...
//	$student = new Student($account->idno);
	...
	echo $sugar_smarty->fetch('modules/Enrollments/templates/printStudyLoadPreschool.tpl');
	echo $sugar_smarty->fetch('modules/Enrollments/templates/printAccountPreschool.tpl');
} else {
