...
//    	$total_rec=0;
    ...
    $main_url="index.php?module=Enrollments&action=listEnrollmentsElem&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel&schYear=$schYear&semCode=$semCode&secID=$secID&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Enrollments/templates/listEnrollmentsElem.tpl');
} else {
