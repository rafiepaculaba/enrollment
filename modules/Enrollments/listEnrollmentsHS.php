...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $secID   = $_SESSION[$_GET['module'].'HS_secID'];
    }
    ...
    $_SESSION[$_GET['module'].'HS_secID']     = $secID;
...
//    	$total_rec=0;
    ...
    $main_url="index.php?module=Enrollments&action=listEnrollmentsHS&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel&schYear=$schYear&semCode=$semCode&secID=$secID&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Enrollments/templates/listEnrollmentsHS.tpl');
} else {
