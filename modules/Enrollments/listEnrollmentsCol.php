...
//    $allEnrollments = $enrollment->retrieveAllEnrollments($conds);
    ...
    $main_url="index.php?module=Enrollments&action=listEnrollmentsCol&idno=$idno&lname=$lname&fname=$fname&mname=$mname&gender=$gender&courseID=$courseId&yrLevel=$yrLevel&schYear=$schYear&semCode=$semCode&rstatus=$rstatus";
    ...
    echo $sugar_smarty->fetch('modules/Enrollments/templates/listEnrollmentsCol.tpl');
} else {
