...
<?php if ($enID) { ?>
    setTimeout("redirect('index.php?module=Enrollments&action=viewEnrollmentElem&enID=<?php echo $enID; ?>')");
<?php } else { ?>
    setTimeout("redirect('index.php?module=Enrollments&action=createEnrollmentElem')");
<?php } ?>
</script>