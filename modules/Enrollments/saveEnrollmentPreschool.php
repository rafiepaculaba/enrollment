...
<?php if ($enID) { ?>
    setTimeout("redirect('index.php?module=Enrollments&action=viewEnrollmentPreschool&enID=<?php echo $enID; ?>')");
<?php } else { ?>
    setTimeout("redirect('index.php?module=Enrollments&action=createEnrollmentPreschool')");
<?php } ?>
</script>