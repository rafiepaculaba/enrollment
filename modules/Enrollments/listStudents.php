...
global $current_user;
    ...
    if ($_GET['cmdFilter']) {
        ...
        $idno     	= $_SESSION[$_GET['module'].'Colpop_idno'];
        $lname     	= $_SESSION[$_GET['module'].'Colpop_lname'];
    }
    
    //set session variables
	$_SESSION[$_GET['module'].'Colpop_idno']   = $idno;
	$_SESSION[$_GET['module'].'Colpop_lname']  = $lname;
...
//    $allStudents = $stud->retrieveAllStudents($conds);
    ...
    $main_url="index.php?module=Enrollments&action=listStudents&idno=$idno&lname=$lname&sugar_body_only=1";
    ...
    echo $sugar_smarty->fetch('modules/Enrollments/templates/listStudents.tpl');
?>
