...
if ($_GET['cmdFilter']) {
    ...
    $regID  = $_SESSION[$_GET['module'].'Preschool_regID'];
...
$_SESSION[$_GET['module'].'Preschool_regID']   = $regID;
...
$main_url="index.php?module=Registrations&action=listRegistrationsPreschool&lname=$lname&regID=$regID&rstatus=$rstatus";
...
echo $sugar_smarty->fetch('modules/Registrations/templates/listRegistrationsPreschool.tpl');
?>
