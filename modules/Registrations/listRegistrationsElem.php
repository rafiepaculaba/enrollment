...
if ($_GET['cmdFilter']) {
    ...
    $regID  = $_SESSION[$_GET['module'].'Elem_regID'];
...
$_SESSION[$_GET['module'].'Elem_regID']   = $regID;
...
$main_url="index.php?module=Registrations&action=listRegistrationsElem&lname=$lname&regID=$regID&rstatus=$rstatus";
...
echo $sugar_smarty->fetch('modules/Registrations/templates/listRegistrationsElem.tpl');
?>
