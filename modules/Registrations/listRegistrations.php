...
if ($_GET['cmdFilter']) {
    ...
    $regID  = $_SESSION[$_GET['module'].'Col_regID'];
...
$_SESSION[$_GET['module'].'Col_regID']   = $regID;
...
$main_url="index.php?module=Registrations&action=listRegistrations&lname=$lname&regID=$regID&rstatus=$rstatus";
...
echo $sugar_smarty->fetch('modules/Registrations/templates/listRegistrations.tpl');
?>
<script>
$('regID').focus();
</script>