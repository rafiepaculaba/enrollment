<form name="frmRegistration" id="frmRegistration" method="post" action="index.php?module=Registrations&action=saveRegistration" onsubmit="return check_form('frmRegistration')">

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="submit" id="cmdSave" value=" Save " />
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Registrations&action=listRegistrations')" />
    </td>
...
<tr><td>
    ...
    <tr>
        ...
        <td class="dataField">
            ...
            <tr>
                <td width="30%" valign="top">Last Name</td>
                <td width="30%" valign="top">First Name</td>
                <td width="40%" valign="top">Middle Name</td>
            </tr>
            </table>
        </td>
    </tr>
