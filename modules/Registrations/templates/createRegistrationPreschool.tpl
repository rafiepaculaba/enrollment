<form name="frmRegistration" id="frmRegistration" method="post" action="index.php?module=Registrations&action=saveRegistrationPreschool" onsubmit="return check_form('frmRegistration')">

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="submit" id="cmdSave" value=" Save " />
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Registrations&action=listRegistrationsPreschool')" />
    </td>
