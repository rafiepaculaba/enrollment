...
$accessCode = $access->getAccessCode("View Col Registration");
...
function deleteRegistration(regID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Registrations&action=deleteRegistration&regID='+regID);
}
</script>