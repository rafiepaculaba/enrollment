...
$accessCode = $access->getAccessCode("View Elem Registration");
...
function deleteRegistration(regID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Registrations&action=deleteRegistrationElem&regID='+regID);
}
</script>