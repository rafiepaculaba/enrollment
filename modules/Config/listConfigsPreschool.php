...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $configID   = $_SESSION[$_GET['module'].'Preschool_configID'];
        $title      = $_SESSION[$_GET['module'].'Preschool_title'];
        $definition = $_SESSION[$_GET['module'].'Preschool_definition'];
    }
    
    $_SESSION[$_GET['module'].'Preschool_configID']   = $configID;
    $_SESSION[$_GET['module'].'Preschool_title']      = $title;
    $_SESSION[$_GET['module'].'Preschool_definition'] = $definition;
    ...
    $main_url="index.php?module=Config&action=listConfigsPreschool&configID=$configID&title=$title&definition=$definition";
    ...
    echo $sugar_smarty->fetch('modules/Config/templates/listConfigsPreschool.tpl');
} else {
