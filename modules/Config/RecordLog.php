...
/**
 * Edited
 * Filename: master_table_audit_logs.php
 * Date: 	 march 12, 2008
 * 
...
/**
 * Class: master_table_audit_logs
 * Description: This class is a model of the object - master_table_audit_logs
...
{	
	...
	function RecordLog($id='') 
	{
	    ...
	    parent::Database(3); // High school level
