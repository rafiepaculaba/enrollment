<form method="post" name="frmConfig" id="frmConfig" action="index.php?module=Config&action=saveConfigCol" onsubmit="return check_form('frmConfig')" >
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit College Configuration</h4></th>
    </tr>
    <tr>
