<form method="post" name="frmConfig" id="frmConfig" action="index.php?module=Config&action=saveConfigPreschool" onsubmit="return check_form('frmConfig')" >
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit Preschool Configuration</h4></th>
    </tr>
    <tr>
