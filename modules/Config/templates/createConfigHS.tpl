<form name="frmConfig" id="frmConfig" method="post" action="index.php?module=Config&action=saveConfigHS&configID={$configID}" onsubmit="return check_form('frmConfig')">

<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" tabindex="5" type="submit" id="cmdSave" value=" Save " />
    <input class="button" name="cmdCancel" tabindex="6" type="button" id="cmdCancel" value=" Cancel " onClick="redirect('index.php?module=Config&action=listConfigsHS')" />
    </td>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Create HS Configuration</h4></th>
    </tr>
    <tr>
