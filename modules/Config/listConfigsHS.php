...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $configID   = $_SESSION[$_GET['module'].'HS_configID'];
        $title      = $_SESSION[$_GET['module'].'HS_title'];
        $definition = $_SESSION[$_GET['module'].'HS_definition'];
    }
    
    $_SESSION[$_GET['module'].'HS_configID']   = $configID;
    $_SESSION[$_GET['module'].'HS_title']      = $title;
    $_SESSION[$_GET['module'].'HS_definition'] = $definition;
    ...
    echo $sugar_smarty->fetch('modules/Config/templates/listConfigsHS.tpl');
} else {
