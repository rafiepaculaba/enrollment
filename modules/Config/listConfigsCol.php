...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_GET['cmdFilter']) {
        ...
        $configID   = $_SESSION[$_GET['module'].'Col_configID'];
        $title      = $_SESSION[$_GET['module'].'Col_title'];
        $definition = $_SESSION[$_GET['module'].'Col_definition'];
    }
    
    $_SESSION[$_GET['module'].'Col_configID']   = $configID;
    $_SESSION[$_GET['module'].'Col_title']      = $title;
    $_SESSION[$_GET['module'].'Col_definition'] = $definition;
    ...
    $main_url="index.php?module=Config&action=listConfigsCol&configID=$configID&title=$title&definition=$definition";
    ...
    echo $sugar_smarty->fetch('modules/Config/templates/listConfigsCol.tpl');
} else {
