...
$accessCode = $access->getAccessCode("Delete Elem Registration Payment");
...
setTimeout("redirect('index.php?module=Payments&action=listRegistrationPaymentsElem')", 3000);
</script>