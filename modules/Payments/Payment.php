...
class Payment extends Database 
{
	    ...
	    try {
    		...
    		foreach ($records as $row) {
    		    ...
    		    $paymentType->retrievePaymentType();
    		   	...
    		   	//Student instance 	
    		    $stud->idno = $row['idno'];
    		    $stud->retrieveStudent();
    		     
    		    $data[$ctr] = $row;
    		    
    		    $data[$ctr]['paymentName'] 	= $paymentType->paymentName;

    		    $data[$ctr]['lname'] 	= $stud->lname;
    		    $data[$ctr]['fname'] 	= $stud->fname;
    		    $data[$ctr]['mname'] 	= $stud->mname;
	...
	function retrieveAllStudentPayments($where='',$orderby='', $sorting='ASC', $offset=0, $limit='')
	{
		...
		$multiOrder['payments.semCode'] = "DESC";
