...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete Col Payment");
	...
	if ( $paymentTypeID ) {
	    ...
	    echo $sugar_smarty->fetch('modules/Payments/templates/viewPaymentType.tpl');
	} else {
...
function deletePaymentType(paymentTypeID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Payments&action=deletePaymentType&paymentTypeID='+paymentTypeID);
}
</script>