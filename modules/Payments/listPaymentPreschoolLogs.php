...
$paymentLog = new RecordLog();

$where[0]['docType'] = "= 'Preschool Payment' AND ";
$where[0]['recID'] = "=$paymentID";
$theLogs = $paymentLog->retrieveAllRecordPaymentLogs($where);
...
echo $sugar_smarty->fetch('modules/Payments/templates/listPaymentPreschoolLogs.tpl');
?>
