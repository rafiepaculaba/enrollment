...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/createORHeaderHS.tpl');
...
{
    get_data="particular=" + $('particular').value + "&action=checkduplicateentryhs";
...
function addORItem()
{
    if($('particular').value != '' && $('amount').value != '') {
        get_data="particular=" + $('particular').value + "&amount=" + $('amount').value + "&action=addPaymenths";
...
{
    get_data="orno=" + $('orno').value + "&action=checkduplicateornohs";
...
{
    get_data="particular=" + particular + "&action=removeParticularhs";
