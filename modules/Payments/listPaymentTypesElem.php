...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {	
		...
		$paymentTypeID     	= $_SESSION[$_GET['module'].'Elem_paymentTypeID'];
		$paymentName     	= $_SESSION[$_GET['module'].'Elem_paymentName'];
	}
		
	//set session variables
	$_SESSION[$_GET['module'].'Elem_paymentTypeID']		= $paymentTypeID;
	$_SESSION[$_GET['module'].'Elem_paymentName']		= $paymentName;
	...
	$main_url="index.php?module=Payments&action=listPaymentTypesElem&paymentTypeID=$paymentTypeID&paymentName=$paymentName";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listPaymentTypesElem.tpl');
} else {
