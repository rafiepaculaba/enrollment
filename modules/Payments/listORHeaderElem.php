...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$gender       = $_SESSION[$_GET['module'].'Elem_gender'];
		$schYear      = $_SESSION[$_GET['module'].'Elem_schYear'];
		$semCode      = $_SESSION[$_GET['module'].'Elem_semCode'];
		$term         = $_SESSION[$_GET['module'].'Elem_term'];
		$dateCreated  = $_SESSION[$_GET['module'].'Elem_dateCreated'];
		$totalAmount  = $_SESSION[$_GET['module'].'Elem_totalAmount'];
		$cashier      = $_SESSION[$_GET['module'].'Elem_cashier'];
	...
	$_SESSION[$_GET['module'].'Elem_gender']        = $gender;
	$_SESSION[$_GET['module'].'Elem_schYear']       = $schYear;
	$_SESSION[$_GET['module'].'Elem_semCode']       = $semCode;
	$_SESSION[$_GET['module'].'Elem_cashier']       = $cashier;
    ...
    if (!isset($_SESSION[$_GET['module'].'Elem_rstatus'])) {
        // get default status
        $rstatus = 1;
    }
...
//	$sugar_smarty->assign('user_list', $user_list);
	...
	$main_url="index.php?module=Payments&action=listORHeaderElem&paymentID=$paymentID&orno=$orno&idno=$idno&schYear=$schYear&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listORHeaderElem.tpl');
} else {
