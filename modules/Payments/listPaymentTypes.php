...
require_once('include/blumango/classes/utils/utils.php');
...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$paymentTypeID     	= $_SESSION[$_GET['module'].'Col_paymentTypeID'];
		$paymentName     	= $_SESSION[$_GET['module'].'Col_paymentName'];
	}
	
	//set session variables
	$_SESSION[$_GET['module'].'Col_paymentTypeID']		= $paymentTypeID;
	$_SESSION[$_GET['module'].'Col_paymentName']		= $paymentName;
	...
	$main_url="index.php?module=Payments&action=listPaymentTypes&paymentTypeID=$paymentTypeID&paymentName=$paymentName";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listPaymentTypes.tpl');
} else {
