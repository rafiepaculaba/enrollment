...
echo $sugar_smarty->fetch('modules/Payments/templates/createRegistrationPaymentPreschool.tpl');
...
<script>
addToValidate('frmRegistrationPaymentPreschool','schYear', '', true, 'School Year');
addToValidate('frmRegistrationPaymentPreschool','idno', '', true, 'ID No.');
addToValidate('frmRegistrationPaymentPreschool','ORno', '', true, 'Official Receipt No.');
addToValidate('frmRegistrationPaymentPreschool','date', '', true, 'Date');
...
{
    get_data="schYear=" + $('schYear').value + "&idno=" + $('idno').value + "&action=validatepaymentpreschool";
...
{
    get_data="idno=" + $('idno').value + "&action=checkstudinformationpreschool";
