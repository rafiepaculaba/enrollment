...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {	
		...
		$paymentTypeID     	= $_SESSION[$_GET['module'].'Preschool_paymentTypeID'];
		$paymentName     	= $_SESSION[$_GET['module'].'Preschool_paymentName'];
	}
		
	//set session variables
	$_SESSION[$_GET['module'].'Preschool_paymentTypeID']		= $paymentTypeID;
	$_SESSION[$_GET['module'].'Preschool_paymentName']		= $paymentName;
	...
	$main_url="index.php?module=Payments&action=listPaymentTypesPreschool&paymentTypeID=$paymentTypeID&paymentName=$paymentName";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listPaymentTypesPreschool.tpl');
} else {
