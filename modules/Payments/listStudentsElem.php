...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $main_url="index.php?module=Payments&action=listStudentsElem&idno=$idno&lname=$lname&sugar_body_only=1";
    ...
    echo $sugar_smarty->fetch('modules/Payments/templates/listStudentsElem.tpl');
} else {
