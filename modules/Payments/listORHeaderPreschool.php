...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$paymentID    = $_SESSION[$_GET['module'].'Preschool_paymentID'];
		$orno         = $_SESSION[$_GET['module'].'Preschool_orno'];
		...
		$gender       = $_SESSION[$_GET['module'].'Preschool_gender'];
		$schYear      = $_SESSION[$_GET['module'].'Preschool_schYear'];
		$semCode      = $_SESSION[$_GET['module'].'Preschool_semCode'];
		$term         = $_SESSION[$_GET['module'].'Preschool_term'];
		$dateCreated  = $_SESSION[$_GET['module'].'Preschool_dateCreated'];
		$totalAmount  = $_SESSION[$_GET['module'].'Preschool_totalAmount'];
		$cashier      = $_SESSION[$_GET['module'].'Preschool_cashier'];
		$rstatus      = $_SESSION[$_GET['module'].'Preschool_rstatus'];
	}
	
	//set session variables
    $_SESSION[$_GET['module'].'Preschool_paymentID']     = $paymentID;
	$_SESSION[$_GET['module'].'Preschool_orno']          = $orno;
	...
	$_SESSION[$_GET['module'].'Preschool_gender']        = $gender;
	$_SESSION[$_GET['module'].'Preschool_schYear']       = $schYear;
	$_SESSION[$_GET['module'].'Preschool_semCode']       = $semCode;
	$_SESSION[$_GET['module'].'Preschool_cashier']       = $cashier;
    ...
    if (!isset($_SESSION[$_GET['module'].'Preschool_rstatus'])) {
        // get default status
        $rstatus = 1;
    }
...
//	$sugar_smarty->assign('user_list', $user_list);
	...
	$main_url="index.php?module=Payments&action=listORHeaderPreschool&paymentID=$paymentID&orno=$orno&idno=$idno&schYear=$schYear&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listORHeaderPreschool.tpl');
} else {
