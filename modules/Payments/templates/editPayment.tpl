...
<tr><td width="65%">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit College Payment</h4></th>
    </tr>
        <tr>
        ...
        <td class="dataLabel" width="10%"><slot>Semester  </slot></td>
...
<td width="50%" valign="top">
    ...
    <tr>
        ...
        <td class="dataField" >
        <slot> <input type="text" name="amount" id="amount" value="{$amount}" maxlength="8" size="" onkeypress="return keyRestrict(event, 1);" /> </slot>
        </td>
    </tr>
    </table>
</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
	...
	<tr>
        ...
        <td class="tabDetailViewDF" id="assID_td"><slot>{$assID_td} &nbsp;</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL" ><slot>Amount Paid (Php):</slot></td>
        <td class="tabDetailViewDF" id="assamtPaid"><slot>{$assamtPaid|number_format:2:".":","} &nbsp;</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL" ><slot>Total Balance (Php):</slot></td>
        <td class="tabDetailViewDF" id="balance"><slot>{$assbalance|number_format:2:".":","} &nbsp;</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL" align="left"><h4 class="dataLabel">Total Due (Php): </h4></td>
        <td class="tabDetailViewDF" id="ttlDue"><slot>{$assttlDue|number_format:2:".":","} &nbsp;</slot></td>
    </tr>
</table>
</td>
</tr>
