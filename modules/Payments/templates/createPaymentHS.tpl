<form name="frmPaymentHS" id="frmPaymentHS" method="post" action="index.php?module=Payments&action=savePaymentHS" >
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listPaymentsHS')" />
    </td>
...
<td width="50%" valign="top">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">New High School Payment</h4></th>
    </tr>
        <tr>
    ...
    <tr>
        ...
        <td class="dataField" >
        <slot>
        <input type="text" name="idno" id="idno" value="" size="" maxlength="15" onkeypress="return keyRestrict2(event, 2, 'displayStudentInfoHS');"/>
        </slot>
        </td>
    </tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"">
	...
	<tr>
        ...
        <td class="tabDetailViewDF" width="" id="assID_td"><slot> &nbsp;</slot></td>
    </tr>
    <tr>
