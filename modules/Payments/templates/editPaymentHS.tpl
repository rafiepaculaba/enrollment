...
<td width="50%" valign="top">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit High School Payment</h4></th>
    </tr>
        <tr>
        <td class="dataLabel" width="40%"><slot>School Year  </slot></td>
        <td class="dataField" width="">
        <slot>{$SCHOOLYEAR}
        </slot>
        </td>
    </tr>
