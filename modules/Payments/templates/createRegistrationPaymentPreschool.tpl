<form name="frmRegistrationPaymentPreschool" id="frmRegistrationPaymentPreschool" method="post" action="index.php?module=Payments&action=saveRegistrationPaymentPreschool" >
<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="isFloatAmount();"/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listRegistrationPaymentsPreschool')" />
    </td>
...
<td width="50%" valign="top">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">New Preschool Registration Payment</h4></th>
    </tr>
