...
<tr><td>
    ...
    <tr>
        ...
        <input name="fiscalYear" id="fiscalYear" size="15" maxlength="10" value="{$date}" type="text" onkeypress="return keyRestrict(event, 8);" />
        </slot></td>
    </tr>
    <tr>
        <td class="dataLabel" width="18%"><slot>First No. <span class="required">*</span> </slot></td>
        <td class="dataField" width="82%">
        <slot> <input type="text" name="firstORNO" id="firstORNO" size="30" /> </slot>
        </td>
    </tr>
    <tr>
        <td class="dataLabel" width="18%"><slot>Last No. <span class="required">*</span> </slot></td>
        <td class="dataField" width="82%">
        <slot> <input type="text" name="lastORNO" id="lastORNO" size="30" /> </slot>
        </td>
    </tr>
    <tr>
