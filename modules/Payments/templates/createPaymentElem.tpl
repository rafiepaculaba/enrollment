...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listPaymentsElem')" />
    </td>
...
<td width="50%" valign="top">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">New Elementary Payment</h4></th>
    </tr>
        <tr>
    ...
    <tr>
        ...
        <td class="dataField" >
        <slot>
        <input type="text" name="idno" id="idno" value="" size="" maxlength="15" onkeypress="return keyRestrict2(event, 2, 'displayStudentInfoElem');"/>
        </slot>
        </td>
    </tr>
    <tr>
