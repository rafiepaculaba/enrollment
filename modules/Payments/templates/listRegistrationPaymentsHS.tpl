<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td nowrap="nowrap"><h3><img src="themes/Sugar/images/h3Arrow.gif" border="0" height="11" width="11">&nbsp;High School Registration Payments </h3></td><td width="100%"><img src="include/images/blank.gif" alt="" height="1" width="1"></td>
	</tr>
</table>
<p>
<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap>Registration No. </td>
	...
	<tr height="20">
	    <form name="frmFilter" id="frmFilter" method="GET" action="index.php?module=Payments&action=listRegistrationPaymentsHS">
	    <input type="hidden" name="module" value="Payments" />
	    <input type="hidden" name="action" value="listRegistrationPaymentsHS" />
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1">{$SCHOOLYEAR}</td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="regPaymentID" id="regPaymentID" size="10" maxlength="20" value="{$regPaymentID}" onkeypress="return keyRestrict(event, 1);"/></td>
		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1"><input type="text" name="ORno" id="ORno" size="15" maxlength="10" value="{$ORno}" onkeypress="return keyRestrict(event, 1);"/></td>
		...
		<select name="type" id="type">
	        <option value="">----------------</option>
	        <option value="1" {if $type eq "1"} selected {/if}> Registration </option>
	        <option value="2" {if $type eq "2"} selected {/if}> Down Payment </option>
        </select> 		
        </td>		<td scope="row" class="evenListRowS1" nowrap  class="listViewPaginationTdS1">
	...
	{if $list neq ""}	
		...
		<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Payments&action=viewRegistrationPaymentHS&regPaymentID={$list[i].regPaymentID}" class="listViewTdLinkS1">{$list[i].regPaymentID}</a></span></td>
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Payments&action=viewRegistrationPaymentHS&regPaymentID={$list[i].regPaymentID}" class="listViewTdLinkS1">{$list[i].idno}</a></span></td>
	        ...
	        {else}
	            class="oddListRowS1" bgcolor="#ffffff" 
	        {/if}
	        align="left" bgcolor="#fdfdfd" valign="top">{if $list[i].type eq 1 } Registration {/if} {if $list[i].type eq 2 } Down Payment {/if}</td>
