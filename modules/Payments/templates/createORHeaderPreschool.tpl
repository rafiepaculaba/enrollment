<form name="frmORHeader" id="frmORHeader" method="post" action="index.php?module=Payments&action=saveORHeaderPreschool" >
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listORHeaderPreschool')" />
    </td>
...
<tbody><tr><td>
    ...
    <tr>
        ...
        <td class="dataField" width="32%">
            ...
            <input type="button" name="cmdLookup" id="cmdLookup" value="=" onclick="popUp('index.php?module=Payments&action=listStudentsPreschool&sugar_body_only=1')" />
        </td>
        <td class="dataLabel" align="right" width="17%">Grade</td>
        <td class="dataField" width="33%">
