...
<input type="hidden" name="semCode" id="semCode" value="{$sem_code}" />
<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="onCheckEntry();" />
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listORHeader')" />
    </td>
...
<tbody><tr><td>
    ...
    <tr>
        ...
        <td class="dataField" width="32%">
            ...
            <input type="button" name="cmdLookup" id="cmdLookup" value="=" onclick="popUp('index.php?module=Payments&action=listStudents&sugar_body_only=1')" />
        </td>
        <td class="dataLabel" align="right" width="17%">Course-Year</td>
        <td class="dataField" width="33%">
            <input name="course" id="course" value="{$course}" maxlength="15" type="text" readonly>
        </td>
    </tr>
    <tr>
