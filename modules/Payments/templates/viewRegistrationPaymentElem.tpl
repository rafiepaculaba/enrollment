...
<a class="current" id="tab_link_Payment_info" href="index.php?module=Payments&action=viewRegistrationPaymentElem&regPaymentID={$regPaymentID}">Payment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Payments&action=listRegistrationPaymentElemLogs&regPaymentID={$regPaymentID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Payments&action=listRegistrationPaymentsElem');" />
    
	{if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Payments&action=editRegistrationPaymentElem&regPaymentID={$regPaymentID}');" />
    {/if}
