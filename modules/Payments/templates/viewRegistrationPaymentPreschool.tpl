...
<a class="current" id="tab_link_Payment_info" href="index.php?module=Payments&action=viewRegistrationPaymentPreschool&regPaymentID={$regPaymentID}">Payment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Payments&action=listRegistrationPaymentPreschoolLogs&regPaymentID={$regPaymentID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Payments&action=listRegistrationPaymentsPreschool');" />
    
	{if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Payments&action=editRegistrationPaymentPreschool&regPaymentID={$regPaymentID}');" />
    {/if}
    
	{if $hasCancel eq 1 }
    <input class="button" name="cmdcancel" type="button" id="cmdcancel" value=" Cancel Payment " onclick="cancelRegistrationPayment('{$regPaymentID}','{$schYear}','{$idno}','{$amount}','{$type}');" />
    {/if}
  </tr>
</table>  
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td class="tabDetailViewDF" ><slot>{$dtype} &nbsp;</slot></td>
    </tr>
	<tr>
