<form name="frmRegistrationPaymentElem" id="frmRegistrationPaymentElem" method="post" action="index.php?module=Payments&action=saveRegistrationPaymentElem" >
<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="isFloatAmount();"/>
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listRegistrationPaymentsElem')" />
    </td>
...
<td width="50%" valign="top">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">New Elementary Registration Payment</h4></th>
    </tr>
