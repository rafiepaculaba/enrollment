...
<td width="50%" valign="top">
	...
	<tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Edit College Registration Payment</h4></th>
    </tr>
        <tr>
	...
	<tr>
        ...
        <td class="dataLabel" ><slot>Semester  </slot></td>
        <td class="dataField" >
        <slot>{$SEMESTERS}
        </slot>
        </td>
    ...
    <tr>
        ...
        <td class="dataField">
        <slot>
        <input type="text" name="idno" id="idno" value="{$idno}" maxlength="15" onkeypress="return keyRestrict(event, 2);" readonly/>
        </slot>
        </td>
    </tr>
    <tr>
