<form name="frmORHeader" id="frmORHeader" method="post" action="index.php?module=Payments&action=saveORHeaderHS" >
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listORHeaderHS')" />
    </td>
...
<tbody><tr><td>
    ...
    <tr>
        ...
        <td class="dataField" width="32%">
            ...
            <input type="button" name="cmdLookup" id="cmdLookup" value="=" onclick="popUp('index.php?module=Payments&action=listStudentsHS&sugar_body_only=1')" />
        </td>
