<form name="frmRegistrationPayment" id="frmRegistrationPayment" method="post" action="index.php?module=Payments&action=saveRegistrationPayment" >
<table width="100%" border="0">
  <tr>
    <td>
    <input class="button" name="cmdSave" type="button" id="cmdSave" value=" Save " onclick="isFloatAmount();" />
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Payments&action=listRegistrationPayments')" />
    </td>
...
<td width="50%" valign="top">
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">New College Registration Payment</h4></th>
    </tr>
     <tr>
    ...
    <tr>
        ...
        <td class="dataField">
        <slot>
			<input type="text" name="idno" id="idno" size="" maxlength="15" onkeypress="return keyRestrict2(event, 2, 'displayStudentInfo');" />
        </slot>
        </td>
    </tr>
    <tr>
