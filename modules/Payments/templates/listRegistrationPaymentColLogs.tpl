...
<a id="tab_link_Payment_info" href="index.php?module=Payments&action=viewRegistrationPayment&regPaymentID={$regPaymentID}">Payment Form</a>
</li>	
<li id="tab_li_log">
<a  class="current" id="tab_link_log" href="index.php?module=Payments&action=listRegistrationPaymentColLogs&regPaymentID={$regPaymentID}">View Logs</a>
</li>	
</ul>
</p>
