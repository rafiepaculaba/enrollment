...
<a class="current" id="tab_link_Payment_info" href="index.php?module=Payments&action=viewORHeaderElem&paymentID={$paymentID}">Payment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Payments&action=listPaymentElemLogs&paymentID={$paymentID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Payments&action=listORHeaderElem');" />
   ...
   {if $hasPrint eq 1 }
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Payments&action=printORHeaderElem&paymentID={$paymentID}&sugar_body_only=1');" />
    {/if}

    {if $hasPrint eq 1 }
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Split Print" onclick="popUp('index.php?module=Payments&action=printSplitORHeaderElem&paymentID={$paymentID}&sugar_body_only=1');" />
    {/if}
...
<tbody><tr><td>
    ...
    <tr>
        <td class="tabDetailViewDL" width="18%"><slot>Grade &nbsp;</slot></td>
