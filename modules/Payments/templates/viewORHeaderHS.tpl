...
<a class="current" id="tab_link_Payment_info" href="index.php?module=Payments&action=viewORHeaderHS&paymentID={$paymentID}">Payment Form</a>
</li>	
<li id="tab_li_log">
<a id="tab_link_log" href="index.php?module=Payments&action=listPaymentHSLogs&paymentID={$paymentID}">View Logs</a>
</li>	
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Payments&action=listORHeaderHS');" />
   ...
   {if $hasPrint eq 1 }
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Print" onclick="popUp('index.php?module=Payments&action=printORHeaderHS&paymentID={$paymentID}&sugar_body_only=1');" />
    {/if}

    {if $hasPrint eq 1 }
    <input class="button" name="cmdprint" type="button" id="cmdprint" value="Split Print" onclick="popUp('index.php?module=Payments&action=printSplitORHeaderHS&paymentID={$paymentID}&sugar_body_only=1');" />
    {/if}
