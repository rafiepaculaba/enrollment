...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete HS Payment");
	...
	if ( $paymentTypeID ) {
	    ...
	    echo $sugar_smarty->fetch('modules/Payments/templates/viewPaymentTypeHS.tpl');
	} else {
...
function deletePaymentTypeHS(paymentTypeID)
{
    reply=confirm("Do you really want to delete the Payment Type?");
    
    if (reply==true)
        redirect('index.php?module=Payments&action=deletePaymentTypeHS&paymentTypeID='+paymentTypeID);
}
</script>