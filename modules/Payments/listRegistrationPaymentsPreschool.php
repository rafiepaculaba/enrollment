...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$schYear     		= $_SESSION[$_GET['module'].'regPreschool_schYear'];	
		$regPaymentID     	= $_SESSION[$_GET['module'].'regPreschool_regPaymentID'];	
		$ORno     			= $_SESSION[$_GET['module'].'regPreschool_ORno'];	
		$type     			= $_SESSION[$_GET['module'].'regPreschool_type'];	
		$idno     			= $_SESSION[$_GET['module'].'regPreschool_idno'];	
		$lname     			= $_SESSION[$_GET['module'].'regPreschool_lname'];	
		$fname     			= $_SESSION[$_GET['module'].'regPreschool_fname'];	
		$mname     			= $_SESSION[$_GET['module'].'regPreschool_mname'];	
		$rstatus     		= $_SESSION[$_GET['module'].'regPreschool_rstatus'];	
	}
	
	if (!isset($_GET['schYear']) && !isset($_SESSION[$_GET['module'].'regPreschool_schYear'])) {
        // get the default schYear
        $schYear = $config->getConfig('School Year');
    }
    	
	//set session variables
	$_SESSION[$_GET['module'].'regPreschool_schYear']		= $schYear;
	$_SESSION[$_GET['module'].'regPreschool_regPaymentID']	= $regPaymentID;
	$_SESSION[$_GET['module'].'regPreschool_ORno']			= $ORno;
	$_SESSION[$_GET['module'].'regPreschool_type']			= $type;
	$_SESSION[$_GET['module'].'regPreschool_idno']			= $idno;
	$_SESSION[$_GET['module'].'regPreschool_lname']			= $lname;
	$_SESSION[$_GET['module'].'regPreschool_fname']			= $fname;
	$_SESSION[$_GET['module'].'regPreschool_mname']			= $mname;
	$_SESSION[$_GET['module'].'regPreschool_rstatus']		= $rstatus;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Payments&action=listRegistrationPaymentsPreschool&regPaymentID=$regPaymentID&schYear=$schYear&ORno=$ORno&idno=$idno&lname=$lname&fname=$fname&mname=$mname&type=$type&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listRegistrationPaymentsPreschool.tpl');
