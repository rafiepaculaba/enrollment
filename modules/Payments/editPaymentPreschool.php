...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	//terms
	$colterms='<select name="term" id="term" onchange = "displayAccountsPreschool();" disabled>'."\n";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/editPaymentPreschool.tpl');
...
addToValidate('frmPaymentPreschool','ORno', '', true, 'OR #');
</script>
