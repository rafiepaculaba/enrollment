...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete Preschool Payment");
	...
	if ( $paymentTypeID ) {
	    ...
	    echo $sugar_smarty->fetch('modules/Payments/templates/viewPaymentTypePreschool.tpl');
	} else {
...
function deletePaymentTypePreschool(paymentTypeID)
{
    reply=confirm("Do you really want to delete the Payment Type?");
    
    if (reply==true)
        redirect('index.php?module=Payments&action=deletePaymentTypePreschool&paymentTypeID='+paymentTypeID);
}
</script>