...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	if ($_GET['cmdFilter']) {
		...
		$schYear     		= $_SESSION[$_GET['module'].'regElem_schYear'];	
		$regPaymentID     	= $_SESSION[$_GET['module'].'regElem_regPaymentID'];	
		$ORno     			= $_SESSION[$_GET['module'].'regElem_ORno'];	
		$type     			= $_SESSION[$_GET['module'].'regElem_type'];	
		$idno     			= $_SESSION[$_GET['module'].'regElem_idno'];	
		$lname     			= $_SESSION[$_GET['module'].'regElem_lname'];	
		$fname     			= $_SESSION[$_GET['module'].'regElem_fname'];	
		$mname     			= $_SESSION[$_GET['module'].'regElem_mname'];	
		$rstatus     		= $_SESSION[$_GET['module'].'regElem_rstatus'];	
	}
	
	if (!isset($_GET['schYear']) && !isset($_SESSION[$_GET['module'].'regElem_schYear'])) {
        // get the default schYear
        $schYear = $config->getConfig('School Year');
    }
    	
	//set session variables
	$_SESSION[$_GET['module'].'regElem_schYear']		= $schYear;
	$_SESSION[$_GET['module'].'regElem_regPaymentID']	= $regPaymentID;
	$_SESSION[$_GET['module'].'regElem_ORno']			= $ORno;
	$_SESSION[$_GET['module'].'regElem_type']			= $type;
	$_SESSION[$_GET['module'].'regElem_idno']			= $idno;
	$_SESSION[$_GET['module'].'regElem_lname']			= $lname;
	$_SESSION[$_GET['module'].'regElem_fname']			= $fname;
	$_SESSION[$_GET['module'].'regElem_mname']			= $mname;
	$_SESSION[$_GET['module'].'regElem_rstatus']		= $rstatus;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Payments&action=listRegistrationPaymentsElem&regPaymentID=$regPaymentID&schYear=$schYear&ORno=$ORno&idno=$idno&lname=$lname&fname=$fname&mname=$mname&type=$type&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listRegistrationPaymentsElem.tpl');
