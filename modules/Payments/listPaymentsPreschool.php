...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$_SESSION[$_GET['module'].'Preschool_term']		= $term;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Payments&action=listPaymentsPreschool&paymentID=$paymentID&schYear=$schYear&term=$term&ORno=$ORno&idno=$idno&lname=$lname&fname=$fname&mname=$mname&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listPaymentsPreschool.tpl');
