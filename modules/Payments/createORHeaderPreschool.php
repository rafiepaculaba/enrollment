...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    unset($_SESSION['ORITEMSPRESCHOOL']);
	...
	//Pre school
	$miscellaneouspre = $config->getConfig('Misc Account Code Preschool');
	$laboratorypre    = $config->getConfig('Lab Account Code Preschool');
	$compSubjpre      = $config->getConfig('Computer Subj Code Preschool');
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/createORHeaderPreschool.tpl');
...
{
    get_data="particular=" + $('particular').value + "&action=checkduplicateentrypreschool";
...
function addORItem()
{
    if($('particular').value != '' && $('amount').value != '') {
        get_data="particular=" + $('particular').value + "&amount=" + $('amount').value + "&action=addPaymentpreschool";
...
{
    if ($('orno').value != '') {
        get_data="action=checkentrypreschool";
...
{
    get_data="orno=" + $('orno').value + "&action=checkduplicateornopreschool";
...
{
    get_data="particular=" + particular + "&action=removeParticularPreschool";
