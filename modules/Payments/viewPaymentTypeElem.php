...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    $accessCode = $access->getAccessCode("Delete Elem Payment");
	...
	if ( $paymentTypeID ) {
	    ...
	    echo $sugar_smarty->fetch('modules/Payments/templates/viewPaymentTypeElem.tpl');
	} else {
...
function deletePaymentTypeElem(paymentTypeID)
{
    reply=confirm("Do you really want to delete the Payment Type?");
    
    if (reply==true)
        redirect('index.php?module=Payments&action=deletePaymentTypeElem&paymentTypeID='+paymentTypeID);
}
</script>