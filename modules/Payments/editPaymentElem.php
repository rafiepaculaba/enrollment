...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	//terms
	$colterms='<select name="term" id="term" onchange = "displayAccountsElem();" disabled>'."\n";
	$colterms.='<option value="">-----------------------------------</option>'."\n";
	if ($terms['elem']) {
	    foreach ($terms['elem'] as $key1=>$value1) {
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/editPaymentElem.tpl');
...
addToValidate('frmPaymentElem','ORno', '', true, 'OR #');
</script>
