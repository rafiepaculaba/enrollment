...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$_SESSION[$_GET['module'].'HS_term']		= $term;
...
//		$total_rec=0;
	...
	$main_url="index.php?module=Payments&action=listPaymentsHS&paymentID=$paymentID&schYear=$schYear&term=$term&ORno=$ORno&idno=$idno&lname=$lname&fname=$fname&mname=$mname&rstatus=$rstatus";
	...
	echo $sugar_smarty->fetch('modules/Payments/templates/listPaymentsHS.tpl');
