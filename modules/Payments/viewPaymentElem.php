...
$accessCode = $access->getAccessCode("View Elem Payment");
...
/*function deletePayment(paymentID)
{
    ...
    if (reply==true)
        redirect('index.php?module=Payments&action=deletePaymentElem&paymentID='+paymentID);
}*/
function cancelPaymentElem(paymentID, idno, accID, schYear, term, amount)
{
    reply=confirm("Do you really want to cancel the Payment?");

    if (reply==true)
        redirect('index.php?module=Payments&action=cancelPaymentElem&paymentID='+paymentID+'&idno='+idno+'&accID='+accID+'&schYear='+schYear+'&term='+term+'&amount='+amount);
}
