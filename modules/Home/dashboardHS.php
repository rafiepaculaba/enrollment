...
echo "\n<p>\n";
echo get_module_title("view_inline", $mod_strings['LBL_MODULE_HS_DASHBOARD'], false);
echo "\n</p>\n";
global $theme;
global $esConfig;
...
if ($access->check_access($current_user->id,$accessCode)) {
	...
	$config = new Config();
        ...
        $sugar_smarty->assign('RESULT', $reportClass->generateEnrollmentStatusHS($result,$total));
...
//		}
    ...
    echo $sugar_smarty->fetch('modules/Home/templates/dashboardHS.tpl');	
} else {
