...
$sugar_smarty = new Sugar_Smarty();
    ...
    $sugar_smarty->assign('RESULT', $reportClass->printCollectionReportCollege($result,$total));
    ...
    echo $sugar_smarty->fetch('modules/Reports/templates/printCollectionReportPreschool.tpl');	
?>
