...
echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME_CUR'], $mod_strings['LBL_MODULE_TITLE_ES_HS'], false);
echo "\n</p>\n";
global $theme;
global $esConfig;
...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    echo $sugar_smarty->fetch('modules/Reports/templates/generateEnrollmentStatusHS.tpl');	
} else {
...
<script>
addToValidate('frmGenerateEnrollmentStatusHS','schYear', '', true, 'School Year');
</script>
