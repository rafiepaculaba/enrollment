...
echo "\n<p>\n";
echo get_module_title('listPromotionary_college', $mod_strings['LBL_MODULE_TITLE_PL_COL'], false);
echo "\n</p>\n";
global $theme;
global $esConfig;
...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_POST['theForm']) {
		...
		$sugar_smarty->assign('RESULT', $reportClass->promotionaryListCollege($records, $courseName, $yrLevel, $semCode, $schName, $schAddress, $schContact, $schRegion));
    ...
    echo $sugar_smarty->fetch('modules/Reports/templates/promotionaryListCol.tpl');	
} else {
...
<script>
addToValidate('frmPromotionaryListCol','schYear', '', true, 'School Year');
addToValidate('frmPromotionaryListCol','semCode', '', true, 'Semester');
addToValidate('frmPromotionaryListCol','courseID', '', true, 'Course');
addToValidate('frmPromotionaryListCol','yrLevel', '', true, 'Year Level');
</script>
