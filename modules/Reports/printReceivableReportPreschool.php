...
$sugar_smarty = new Sugar_Smarty();
    ...
    $sugar_smarty->assign('RESULT', $reportClass->printReceivableReportPreschool($result,$total));
    ...
    echo $sugar_smarty->fetch('modules/Reports/templates/printReceivableReportPreschool.tpl');	
?>
