...
$sugar_smarty->assign('RESULT', $reportClass->printEnrollmentStatusPreschool($result,$total));
...
echo $sugar_smarty->fetch('modules/Reports/templates/printEnrollmentStatusPreschool.tpl');
?>
