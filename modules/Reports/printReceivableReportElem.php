...
$sugar_smarty = new Sugar_Smarty();
    ...
    $sugar_smarty->assign('RESULT', $reportClass->printReceivableReportElem($result,$total));
    ...
    echo $sugar_smarty->fetch('modules/Reports/templates/printReceivableReportElem.tpl');	
?>
