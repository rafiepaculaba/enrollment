...
echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME_CUR'], $mod_strings['LBL_MODULE_TITLE_RR_HS'], false);
echo "\n</p>\n";
global $theme;
global $esConfig;
...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($_POST['theForm']) {
        ...
        $sugar_smarty->assign('RESULT', $reportClass->receivableReportCollege($result,$total));
    ...
    echo $sugar_smarty->fetch('modules/Reports/templates/receivableReportHS.tpl');	
} else {
