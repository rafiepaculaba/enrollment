...
$sugar_smarty->assign('RESULT', $reportClass->printPromotionaryListCollege($records, $courseName, $yrLevel, $semCode, $schName, $schAddress, $schContact, $schRegion));
...
echo $sugar_smarty->fetch('modules/Reports/templates/printPromotionaryListCol.tpl');	
