...
<tr><td>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <th class="tabDetailViewDF" colspan="5" align="left"><h4 class="tabDetailViewDL">College Class Roster</h4></th>
    </tr>
    <tr>
...
<tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" width="45%" nowrap><b>Student Name</b></td>
		<td scope="col" class="listViewThS1" width="10%" nowrap><b>Course</b></td>
           ...
           if($ctr == '1') {
             echo '
             	<tr height="20">
            		...
            		<td scope="col" class="listViewThS1" width="45%" nowrap align="center"><b>Male</b></td>
	...
	{if $list[i].gender eq 'F'}
           ...
           if($ctrf == '1') {
             echo '
             	<tr height="20">
            		<td scope="col" class="listViewThS1" width="5%" nowrap>&nbsp;</td>
            		<td scope="col" class="listViewThS1" width="15%" nowrap>&nbsp;</td>
            		<td scope="col" class="listViewThS1" width="45%" nowrap align="center"><b>Female</b></td>
            		<td scope="col" class="listViewThS1" width="10%" nowrap>&nbsp;</td>
            		<td scope="col" class="listViewThS1" width="10%" nowrap>&nbsp;</td>
            	</tr>
             ';
    	...
    	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
            ...
            {else}
                class="oddListRowS1" bgcolor="#ffffff" 
            {/if}
            align="left" bgcolor="#fdfdfd" valign="top">{php} echo $ctrf; $ctrf++;{/php} &nbsp;</td>
