<form name="frmCashSummaryReport" id="frmCashSummaryReport" method="post" action="index.php?module=Reports&action=cashSummaryReportHS" onsubmit="return check_form('frmCashSummaryReport')" >
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">HIgh School Cash Summary Report</h4></th>
    </tr>
    <tr>
		...
		<td colspan="20" height="20">
			...
			<tbody>
				<tr>
					...
					<div id="printer">
					<a href="#" onclick="popUp('index.php?module=Reports&action=printCashSummaryReportHS&fromdate={$fromdate}&todate={$todate}&sugar_body_only=1');"" id="print_link"><img src="themes/Sugar/images/print.gif" alt="Export" align="absmiddle" border="0" height="9" width="11">&nbsp;Print</a>
					</div>
					</td>
				</tr>
			</tbody>
