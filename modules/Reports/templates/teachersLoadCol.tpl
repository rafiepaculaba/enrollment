<form name="frmTeachersLoadCol" id="frmTeachersLoadCol" method="post" onSubmit="return check_form('frmTeachersLoadCol')">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">College Instructor's Load </h4></th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="dataField" width="32%"><slot> {$SCHOOLYEAR}</slot></td>
        <td class="dataLabel" width="18%"><slot>Semester <span class="required">*</span></slot></td>
        <td class="dataField" width="32%"><slot> {$SEMESTERS}</slot></td>
        </td>
	</tr>
	<tr>
		...
		<td colspan="20" height="20">
			...
			<tbody>
				<tr>
					...
					<div id="printer">
						<a href="#" onclick="popUp('index.php?module=Reports&action=printTeachersLoadCol&schYear={$schYear}&semCode={$semCode}&profID={$profID}&sugar_body_only=1');"" id="print_link"><img src="themes/Sugar/images/print.gif" alt="Export" align="absmiddle" border="0" height="9" width="11">&nbsp;Print</a>
					</div>
					</td>
				</tr>
			</tbody>
