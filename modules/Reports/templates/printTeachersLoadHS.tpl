...
<tr><td>
    ...
    <tr><th  colspan="6" align="center"><br><b><u>High School Teacher's Load</u></b> <br><br></th></tr>
    <tr>
        <td class="tabDetailViewDL" width="70"><slot>Teacher : </slot></td>
        ...
        <td class="tabDetailViewDF" width="150" align="left"><slot><u>{$schYear}</u></slot></td>
    </tr>
    </table>
</td></tr>
</table>
