...
<tr><td>
    ...
    <tr><th  colspan="6" align="center"><br><b><u>High School Cash Summary Report</u></b> <br><br></th></tr>
    <tr>
        <td class="tabDetailViewDL" width="50"><slot>From : </slot></td>
        <td  class="tabDetailView" width="150"><slot> <u>{$fromdate}</u> </slot></td>
        <td class="tabDetailViewDL" width="50"><slot>To : </slot></td>
        <td class="tabDetailViewDF" width="150" align="left"><slot><u>{$todate}</u></slot></td>
    </tr>
    </table>
</td></tr>
</table>
