<form name="frmClassRoster" id="frmClassRoster">
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">View High School Class Roster</h4></th>
    </tr>
    <tr>
		...
		<td colspan="20" height="20">
			...
			<tbody>
				<tr>
					...
					<div id="printer">
					<a href="#" onclick="popUp('index.php?module=Reports&action=classRosterHS&schedID={$SCHEDLIST[i].schedID}&sugar_body_only=1');"" id="print_link"><img src="themes/Sugar/images/print.gif" alt="Export" align="absmiddle" border="0" height="9" width="11">&nbsp;Print</a>
					</div>
					</td>
				</tr>
			</tbody>
