<form name="frmGradesheet" id="frmGradesheet" method="post" >
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">View Preschool Class Roster</h4></th>
    </tr>
    <tr>
    ...
    <tr>
        <td class="dataLabel"><slot>Teacher </slot></td>
        <td class="dataField" colspan="3">
        <slot> 
        <select name="profID" id="profID" onchange="getSchedules();">
        {if $isTeacherGroup eq 0}
        <option value="">-----------------------------------------------------------------------------------------</option>
		{/if}
    ...
    <tr>
        ...
        <td class="dataField" colspan="3"><input type="text" name="subject" id="subject" value="" size="48" readonly /><slot>&nbsp;</slot> </td>
    </tr>
    <tr>
...
<tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" width="65%" nowrap>Student Name</td>
		...
		<td colspan="20" height="20">
			...
			<tbody>
				<tr>
					...
					<div id="printer">
					<a href="#" onclick="popUp('index.php?module=Reports&action=classRosterPreschool&schedID={$SCHEDLIST[i].schedID}&sugar_body_only=1');"" id="print_link"><img src="themes/Sugar/images/print.gif" alt="Export" align="absmiddle" border="0" height="9" width="11">&nbsp;Print</a>
					</div>
					</td>
				</tr>
			</tbody>
