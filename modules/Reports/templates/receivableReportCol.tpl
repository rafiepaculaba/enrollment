<form name="frmReceivableReport" id="frmReceivableReport" method="post" action="index.php?module=Reports&action=receivableReportCol" onsubmit="return check_form('frmReceivableReport')" >
<p>
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">College Receivable Report</h4></th>
    </tr>
    <tr>
		...
		<td colspan="20" height="20">
			...
			<tbody>
				<tr>
					...
					<div id="printer">
					<a href="#" onclick="popUp('index.php?module=Reports&action=printReceivableReportCol&schYear={$schYear}&semCode={$semCode}&term={$term}&sugar_body_only=1');"" id="print_link"><img src="themes/Sugar/images/print.gif" alt="Export" align="absmiddle" border="0" height="9" width="11">&nbsp;Print</a>
					</div>
					</td>
				</tr>
			</tbody>
