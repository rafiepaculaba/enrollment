<form name="frmTeachersLoadPreschool" id="frmTeachersLoadPreschool" method="post" onSubmit="return check_form('frmTeachersLoadPreschool')">
...
<tr><td>
    ...
    <tr>
        <th class="dataField" colspan="2" align="left"><h4 class="dataLabel">Preschool Teacher's Load </h4></th>
    </tr>
    <tr>
		...
		<td colspan="20" height="20">
			...
			<tbody>
				<tr>
					...
					<div id="printer">
						<a href="#" onclick="popUp('index.php?module=Reports&action=printTeachersLoadPreschool&schYear={$schYear}&profID={$profID}&sugar_body_only=1');"" id="print_link"><img src="themes/Sugar/images/print.gif" alt="Export" align="absmiddle" border="0" height="9" width="11">&nbsp;Print</a>
					</div>
					</td>
				</tr>
			</tbody>
