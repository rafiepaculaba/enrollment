...
class ReportClass extends Database 
{
	...
	function collectionReportElementary($result,$total)
	{
	    $form = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
                		...
                		<td scope="col" class="listViewThS1" nowrap width="30%">&nbsp;</td>
                	</tr>';
    	...
    	$form .= '<tr height="20">
                		...
                		<td scope="col" class="evenListRowS1" nowrap><b>&nbsp;</b></td>
                	</tr>
                </tbody>
                </table>';
	...
	function printCollectionReportElementary($result,$total)
	{
	...
	function receivableReportElem($result,$total)
	{
	    $form = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
	...
	function printReceivableReportElem($result,$total)
	{
	    $form = '<table class="listView" border="1" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
                	    <td scope="col" class="listViewThS1" nowrap ><b>&nbsp;&nbsp;Grade</b></td>
                		<td scope="col" class="listViewThS1" nowrap align="center"><b>Total (Php)</b></td>
                	</tr>';
	...
	function generateEnrollmentStatusElem($result,$total)
	{
	    $form = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
	...
	function printEnrollmentStatusElem($result,$total)
	{
	    $form = '<table class="listView" border="1" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
	...
	function teachersLoadElem($result)
	{
	    $form = '<table class="listView" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
	...
	function printTeachersLoadElem($result)
	{
	    $form = '<table class="listView" border="1" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                	<tr height="20">
