...
$sugar_smarty->assign('RESULT', $reportClass->printEnrollmentStatusElem($result,$total));
...
echo $sugar_smarty->fetch('modules/Reports/templates/printEnrollmentStatusElem.tpl');
?>
