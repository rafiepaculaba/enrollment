...
if ( strtoupper($action)=='GETSCHEDULESCOL' ) {
    ...
    $where[0]['schedules.schedID'] = "='$schedID' ";

    $schedule = new Schedule();
    $result   = $schedule->retrieveAllSchedulesAssociated($where);
...
//        $data[0]['room'] = $result[0]['room'];
    ...
    $where[0]['enrollments.rstatus']        = " = '2' AND ";
    ...
    if ($students) {
    	   ...
    	   if ($data['gender'] == 'M') {
        	   if ($ctrm == 1) {
                   $display  .= '<tr height="20">
                    <td scope="col" nowrap><b>Male</b></td>
                    <td scope="col" nowrap>&nbsp;</td>
                    <td scope="col" nowrap>&nbsp;</td>
                    <td scope="col" nowrap>&nbsp;</td>
                    <td scope="col" nowrap>&nbsp;</td>
                    </tr>';
        	   ...
        	   $display  .= '    <td scope="row" ';
                ...
                $display  .= 'align="left" bgcolor="#fdfdfd" valign="top" width="2%">'.$ctrm.'.</td>';
        ...
        foreach ($students as $data) {
    	   ...
    	   if ($data['gender'] == 'F') {
        	   if ($ctrf == 1) {
                   $display  .= '<tr height="20">
                    <td scope="col" nowrap><b>Female</b></td>
                    <td scope="col" nowrap>&nbsp;</td>
                    <td scope="col" nowrap>&nbsp;</td>
                    <td scope="col" nowrap>&nbsp;</td>
                    <td scope="col" nowrap>&nbsp;</td>
        	   ...
        	   $display  .= '    <td scope="row" ';
                ...
                $display  .= 'align="left" bgcolor="#fdfdfd" valign="top" width="2%">'.$ctrf.'.</td>';
    ...
    if ($students) {
        ...
        foreach ($students as $data) {
    	   ...
    	   $display  .= '    <td scope="row" ';
            ...
            $display  .= 'align="left" bgcolor="#fdfdfd" valign="top" width="10%">'.$yrLevel.'&nbsp;</td>';
