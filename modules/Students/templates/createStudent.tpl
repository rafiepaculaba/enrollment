<form enctype="multipart/form-data" name="frmStudent" id="frmStudent" method="post" action="index.php?module=Students&action=saveStudent" >
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Students&action=listStudents')" />
    </td>
...
<tr><td>
   ...
   <!--<tr>
        <td class="dataLabel"><slot>Student ID No. <span class="required">*</span></slot></td>
        <td class="dataField" colspan="3"><slot><input type="text" name="idno" id="idno" maxlength="15" onkeypress="return keyRestrict(event, 14);" /></slot></td>
    </tr>-->
    ...
    <tr>
        ...
        <td class="dataLabel" width="18%" align="right"><slot>Picture  </slot></td>
        <td class="dataField" width="32%">
        <slot> 
        <input name="uploadedfile" type="file" class="button" />
        </slot>
...
<tr><td>
    ...
    <tr>
        ...
        {if $curList[i].major neq ""}        
            <option value="{$curList[i].curID}">{$curList[i].curName} major in {$curList[i].major}</option>
        {else}
            <option value="{$curList[i].curID}">{$curList[i].curName} </option>
        {/if}
        {/section}
        </select>
        </slot>
...
<tr><td>
    ...
    <tr>
        ...
        <td class="dataField"><slot><input type="text" name="interm_edu" id="interm_edu" size="50" maxlength="100" onkeypress="return keyRestrict(event, 6);" /></slot></td>
        <td class="dataLabel"><slot>School Year </slot></td>
        <td class="dataField"><slot><input type="text" name="interm_shcYear" id="interm_shcYear" maxlength="10" onkeypress="return keyRestrict(event, 14);" /></slot></td>
    </tr>
    <tr>
        <td class="dataLabel"><slot>Secondary </slot></td>
        <td class="dataField"><slot><input type="text" name="hs_edu" id="hs_edu" size="50" maxlength="100" onkeypress="return keyRestrict(event, 6);" /></slot></td>
        <td class="dataLabel"><slot>School Year </slot></td>
        <td class="dataField"><slot><input type="text" name="hs_schYear" id="hs_schYear" maxlength="10" onkeypress="return keyRestrict(event, 14);" /></slot></td>
    </tr>
    </table>
</td></tr>
</table>
...
<tr><td>
    ...
    <tr>
        ...
        <!--<input type="text" name="entryDocs" id="entryDocs" value="{$entryDocs}" size="40" maxlength="50" onkeypress="return keyRestrict(event, 6);" />-->
        ...
        <label><input type="checkbox" name="docs[]" value="HD" />HD</label>&nbsp;&nbsp;&nbsp;&nbsp;
        <label><input type="checkbox" name="docs[]" value="TOR" />TOR</label>
	           ...
	           <div style="width: 100%; height:180px; overflow: auto;">
                ...
                <tbody>
                	...
                	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
                        ...
                        {/if}
                        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Students&action=createStudent&regID={$list[i].regID}" class="listViewTdLinkS1">{$list[i].regID}</a></span></td>
