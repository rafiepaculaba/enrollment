<form enctype="multipart/form-data" name="frmStudent" id="frmStudent" method="post" action="index.php?module=Students&action=saveStudentPreschool" onsubmit="return check_form('frmStudent')">
...
<table width="100%" border="0">
  <tr>
    ...
    <input class="button" name="cmdCancel" type="button" id="cmdCancel" value=" Cancel " onclick="redirect('index.php?module=Students&action=listStudentsPreschool')" />
    </td>
...
<tr><td>
    ...
    <tr>
        ...
        <td class="dataField"><slot><input type="text" name="entryDocs" id="entryDocs" value="{$entryDocs}" size="40" maxlength="50" onkeypress="return keyRestrict(event, 6);" /></slot></td>
    </tr>
    </table>
</td></tr>
</table>
	           ...
	           <div style="width: 100%; height:180px; overflow: auto;">
                ...
                <tbody>
                	...
                	<tr onmouseover="setPointer(this, '0', 'over', '#fdfdfd', '#DEEFFF', '');" onmouseout="setPointer(this, '1', 'out', '#fdfdfd', '#DEEFFF', '');" onmousedown="setPointer(this, '0', 'click', '#fdfdfd', '#DEEFFF', '');" height="20">
                        ...
                        {/if}
                        align="left" bgcolor="#fdfdfd" valign="top"><span sugar="sugar0b"><a href="index.php?module=Students&action=createStudentPreschool&regID={$list[i].regID}" class="listViewTdLinkS1">{$list[i].regID}</a></span></td>
