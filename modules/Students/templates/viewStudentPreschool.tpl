...
<a class="current" id="tab_link_Student_info" href="index.php?module=Students&action=viewStudentPreschool&idno={$idno}">Student Profile</a>
</li>

{if $hasViewForm137 eq 1 }	
<li id="tab_li_TOR">
<a id="tab_link_TOR" href="index.php?module=Students&action=viewForm137Preschool&idno={$idno}">Form 137</a>
</li>	
{/if}
</ul>
</p>
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Students&action=listStudentsPreschool');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Students&action=editStudentPreschool&idno={$idno}');" />
    {/if}
    ...
    <tr>
        ...
        <td width="30%" align="center" rowspan="2">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td align="center">
                    <form enctype="multipart/form-data" name="frmStudent" id="frmStudent" method="post" action="index.php?module=Students&action=saveImagePreschool" >
