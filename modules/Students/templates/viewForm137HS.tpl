...
<a id="tab_link_Student_info" href="index.php?module=Students&action=viewStudentHS&idno={$idno}">Student Profile</a>
</li>	
<li class="active" id="tab_li_TOR">
<a class="current" id="tab_link_TOR" href="index.php?module=Students&action=viewForm137HS&idno={$idno}">Form 137</a>
</li>	
</ul>
</p>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <th colspan="5" align="left"><h4 class="tabDetailViewDL">Form 137-A</h4></th>
    </tr>
    <tr>
