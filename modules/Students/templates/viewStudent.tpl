...
<a class="current" id="tab_link_Student_info" href="index.php?module=Students&action=viewStudent&idno={$idno}">Student Profile</a>
</li>
...
<li id="tab_li_TOR">
<a id="tab_link_TOR" href="index.php?module=Students&action=viewProspectus&idno={$idno}">Prospectus</a>
</li>	
...
<table width="100%" border="0">
  <tr>
    <td>
   <input class="button" name="cmdback" type="button" id="cmdback" value="Back to List" onclick="redirect('index.php?module=Students&action=listStudents');" />
    
    {if $hasEdit eq 1 }
    <input class="button" name="cmdedit" type="button" id="cmdedit" value="Edit" onclick="redirect('index.php?module=Students&action=editStudent&idno={$idno}');" />
    {/if}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <td width="30%" align="center" rowspan="2">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    {if $refreshit eq "1"}
                    	<meta http-equiv="refresh" content="1;index.php?module=Students&action=viewStudent&idno={$idno}">
                    {elseif $refreshit eq "2"}
                    {/if}
                    </p>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                    <form enctype="multipart/form-data" name="frmStudent" id="frmStudent" method="post" action="index.php?module=Students&action=saveImageCol" >
    ...
    <tr>
        <td width="70%" valign="top">
			...
			<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
			    <tr>
			        <th class="tabDetailViewDL" colspan="4" align="left"><h4 class="tabDetailViewDL">Course and Year</h4></th>
			    </tr>
			    <tr>
			        <td class="tabDetailViewDL" width="25%"><slot>Course :</slot></td>
			        <td class="tabDetailViewDF"><slot>{$courseCode}- {$courseName}&nbsp;</slot></td>
			        <td class="tabDetailViewDL"><slot>Year :</slot></td>
			        <td class="tabDetailViewDF"><slot>{$yrLevel}&nbsp;</slot></td>
			    </tr>
			    <tr>
			        <td class="tabDetailViewDL"><slot>Curriculum :</slot></td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td class="tabDetailViewDL"><slot>Intermediate :</slot></td>
        <td class="tabDetailViewDF"><slot>{$interm_edu}&nbsp;</slot></td>
        <td class="tabDetailViewDL"><slot>School Year :</slot></td>
        <td class="tabDetailViewDF"><slot>{$interm_shcYear}&nbsp;</slot></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><slot>Secondary :</slot></td>
        <td class="tabDetailViewDF"><slot>{$hs_edu}&nbsp;</slot></td>
        <td class="tabDetailViewDL"><slot>School Year :</slot></td>
        <td class="tabDetailViewDF"><slot>{$hs_schYear}&nbsp;</slot></td>
    </tr>
</table>
</p>
