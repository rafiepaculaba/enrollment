...
<a id="tab_link_Student_info" href="index.php?module=Students&action=viewStudentElem&idno={$idno}">Student Profile</a>
</li>	
<li class="active" id="tab_li_TOR">
<a class="current" id="tab_link_TOR" href="index.php?module=Students&action=viewForm137Elem&idno={$idno}">Form 137</a>
</li>	
</ul>
</p>
