...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        <slot>
            ...
            {/if}
            <tr>
                <td align="center" > <b>{$schName}</b><br>{$schAddress}<br>{$schContact} </td>
            </tr>
            </table>
        </slot>
        </td>
    </tr>
     <tr><th  colspan="4" align="center"><br><b><u>College Students</u></b> <br><br></th></tr>
</table>    
<p>
<table class="listView" border="1" cellpadding="0" cellspacing="0" width="100%"><tbody>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" width="22%" nowrap><b>Last Name</b></td>
		<td scope="col" class="listViewThS1" width="22%" nowrap><b>First Name</b></td>
		<td scope="col" class="listViewThS1" width="21%" nowrap><b>Middle Name</b></td>
