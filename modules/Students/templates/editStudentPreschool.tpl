<form name="frmStudent" id="frmStudent" method="post" action="index.php?module=Students&action=saveStudentPreschool" onsubmit="return check_form('frmStudent')">
...
<tr><td>
    ...
    <tr>
        ...
        <td class="dataField" colspan="3" width="82%"><slot><input type="text" name="idno" id="idno" readonly value="{$idno}" size="25" onkeypress="return keyRestrict(event, 14);" /> (readonly)</slot></td>
    </tr>
    <tr>
...
<tr><td>
    ...
    <tr>
        ...
        <td class="dataLabel" width="18%"><slot>Nationality <span class="required">*</span></slot></td>
        <td class="dataField" width="32%">
