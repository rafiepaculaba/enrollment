...
require ('modules/Students/StudentPreschool.php');
...
$accessCode = $access->getAccessCode("View Preschool Student");
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if (!$idno) {
        ...
        if ( $stud->isExist($idno) ) {
            ...
            $accessCode = $access->getAccessCode("Delete Preschool Student");
            ...
            $accessCode = $access->getAccessCode("View Preschool Form137");
            ...
            foreach ($allowed_filetypes as $value) {
                if (is_file("uploads/preschool_students/".$stud->idno.$value)) {
                    $image = "uploads/preschool_students/".$stud->idno.$value;
                    break;
                }	
            }
            ...
            echo $sugar_smarty->fetch('modules/Students/templates/viewStudentPreschool.tpl');
        } else {
...
function deleteStudent(idno)
{
    ...
    if (reply==true)
        redirect('index.php?module=Students&action=deleteStudentPreschool&idno='+idno);
}
</script>