...
//    	$total_rec=0;
    ...
    $print_link = "index.php?module=Students&action=printStudentsElem";
    
    $main_url="index.php?module=Students&action=listStudentsElem&idno=$idno&lname=$lname&fname=$fname&mname=$mname&yrLevel=$yrLevel";
    ...
    echo $sugar_smarty->fetch('modules/Students/templates/listStudentsElem.tpl');
} else {
