...
if ($access->check_access($current_user->id,$accessCode)) {
    ...
    if ($gender) {
       $conds[0]['gender'] = " like '$gender%' AND ";
    }
...
//    $allStudents = $stud->retrieveAllStudents($conds);
    ...
    $main_url="index.php?module=Students&action=listStudents&idno=$idno&schYear=$schYear&semCode=$semCode&lname=$lname&fname=$fname&mname=$mname&gender=$gender&courseID=$courseID&yrLevel=$yrLevel";
    ...
    $print_link = "index.php?module=Students&action=printStudentsCol";
    ...
    echo $sugar_smarty->fetch('modules/Students/templates/listStudents.tpl');
} else {
