...
if (!installed_sugarmodule('Advanced Project Management')){
	require_once('modules/ProjectTask/Dashlets/MyProjectTaskDashlet/MyProjectTaskDashlet.data.php');
}
else{
	require_once('modules/ProjectTask/Dashlets/MyProjectTaskDashlet/MyProjectTaskDashlet.apm.data.php');
}
