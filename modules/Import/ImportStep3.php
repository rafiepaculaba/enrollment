...
if (!move_uploaded_file($_FILES['userfile']['tmp_name'], $tmp_file_name)) {
	show_error_import($mod_strings['LBL_IMPORT_MODULE_ERROR_NO_MOVE'].' '.$tmp_file_name);
	exit;
}
...
$chooser_array [0] = $tmp_chooser_array; 
    ...
    $chooser->args['title'] =  $mod_strings['LBL_VERIFY_DUPS'];
//    _pp($chooser);
