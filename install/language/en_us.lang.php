...
/*********************************************************************************
 * The contents of this file are subject to the QuickEnroll Public License Version
 * 1.1.3 ("License"); You may not use this file except in compliance with the
 * License. You may obtain a copy of the License at http://www.blumango.com/
 ...
 *    (i) the "Powered by QuickEnroll" logo and
 *    (ii) the QuickEnroll copyright notice
 * in the same form as they appear in the distribution.  See full license for
 * requirements.
 *
 * The Original Code is: QuickEnroll Open Source
 * The Initial Developer of the Original Code is blumango Technologies, Inc.
 * Portions created by QuickEnroll are Copyright (C) 2004-2006 blumango, Inc.;
 * All Rights Reserved.
 ...
 * Description:
 * Portions created by QuickEnroll are Copyright (C) QuickEnroll, Inc. All Rights
...
$mod_strings = array(
	...
	'ERR_ADMIN_PASS_BLANK'				=> 'QuickEnroll admin password cannot be blank.',
    ...
    'ERR_CHECKSYS_CURL'					=> 'Not found: QuickEnroll Scheduler will run with limited functionality.',
	...
	'ERR_CHECKSYS_MBSTRING'				=> 'Not found: QuickEnroll will not be able to process multi-byte characters.  This will impact receiving emails in character sets other than UTF-8.',
    ...
    'ERR_CHECKSYS_ZLIB'					=> 'Not Found: QuickEnroll reaps enormous performance benefits with zlib compression.',
	...
	'ERR_DB_EXISTS_WITH_CONFIG'			=> 'Database already exists with config data.  To run an install with the chosen database, please re-run the install and choose: "Drop and recreate existing QuickEnroll tables?"  To upgrade, use the Upgrade Wizard in the Admin Console.  Please read the upgrade documentation located <a href="http://www.blumango.com" target="_new">here</a>.',
	...
	'ERR_DB_LOGIN_FAILURE_MYSQL'		=> 'QuickEnroll database user name and/or password is invalid (Error ',
	'ERR_DB_LOGIN_FAILURE_MSSQL'		=> 'QuickEnroll database user name and/or password is invalid.',
	...
	'ERR_DB_PASSWORD'					=> 'Passwords for QuickEnroll do not match.',
	'ERR_DB_PRIV_USER'					=> 'Database admin user name is required.',
	'ERR_DB_USER_EXISTS'				=> 'User name for QuickEnroll already exists--cannot create another one with the same name.',
	'ERR_DB_USER'						=> 'User name for QuickEnroll cannot be blank.',
	...
	'ERR_PASSWORD_MISMATCH'				=> 'Passwords for QuickEnroll admin do not match.',
	...
	'ERR_SI_NO_CONFIG'					=> 'You did not include config_si.php in the document root, or you did not define $QuickEnroll_config_si in config.php',
	...
	'ERROR_FLAVOR_INCOMPATIBLE'			=> 'The uploaded file is not compatible with this flavor (Open Source, Professional, or Enterprise) of QuickEnroll Suite: ',
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'The uploaded file is not compatible with this version of QuickEnroll Suite: ',
	
	'LBL_BACK'							=> 'Back',
	'LBL_CHECKSYS_1'					=> 'In order for your QuickEnroll installation to function properly, please ensure all of the system check items listed below are green. If any are red, please take the necessary steps to fix them.',
	...
	'LBL_CHECKSYS_CONFIG'				=> 'Writable QuickEnroll Configuration File (config.php)',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Caution: All QuickEnroll data will be erased<br>if this box is checked.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Drop and Recreate Existing QuickEnroll tables?',
	...
	'LBL_DISABLED_HELP_1'				=> 'For installation help, please visit the QuickEnroll',
	'LBL_DISABLED_HELP_2'				=> 'support forums',
	'LBL_DISABLED_TITLE_2'				=> 'QuickEnroll Installation has been Disabled',
	'LBL_DISABLED_TITLE'				=> 'QuickEnroll Installation Disabled',
	...
	'LBL_LICENSE_TITLE_2'				=> 'QuickEnroll License',
	...
	'LBL_LOCALE_DESC'					=> 'Adjust your QuickEnroll Locale settings below.',
	...
	'LBL_PERFORM_CONFIG_PHP'			=> 'Creating QuickEnroll configuration file',
	...
	'LBL_PERFORM_CREATE_DEFAULT'		=> 'Creating default QuickEnroll data',
	'LBL_PERFORM_CREATE_LOCALHOST'		=> 'Creating the Database username and password for localhost...',
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'Creating QuickEnroll relationship tables',
	...
	'LBL_PERFORM_OUTRO_1'				=> 'The setup of QuickEnroll ',
	...
	'LBL_PERFORM_TABLES'				=> 'Creating QuickEnroll application tables, audit tables, and relationship metadata...',
	'LBL_PERFORM_TITLE'					=> 'Perform Setup',
	'LBL_PRINT'							=> 'Print',
	'LBL_REG_CONF_1'					=> 'Please take a moment to register with QuickEnroll by filling out the short form below. By letting us know a little bit about how your company plans to use QuickEnroll, we can ensure we are always delivering the right product for your business needs. If you are interested in receiving information about QuickEnroll, please opt-in to our mailing list. We do not sell, rent, share, or otherwise distribute the information collected here to  third parties.',
	...
	'LBL_REG_CONF_3'					=> 'Thank you for registering. Click on the Finish button to login to QuickEnroll. You will need to log in for the first time using the username "admin" and the password you entered in step 2.',
	'LBL_REG_TITLE'						=> 'Registration',
	'LBL_REQUIRED'						=> '* Required field',
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Re-enter QuickEnroll <em>Admin</em> Password',
	'LBL_SITECFG_ADMIN_PASS_WARN'		=> 'Caution: This will override the admin password of any previous installation.',
	'LBL_SITECFG_ADMIN_PASS'			=> 'QuickEnroll <em>Admin</em> Password',
	'LBL_SITECFG_APP_ID'				=> 'Application ID',
	'LBL_SITECFG_CUSTOM_ID_DIRECTIONS'	=> 'Override the auto-generated application ID that prevents sessions from one instance of QuickEnroll from being used on another instance.  If you have a cluster of QuickEnroll installations, they all must share the same application ID.',
	'LBL_SITECFG_CUSTOM_ID'				=> 'Provide Your Own Application ID',
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'Override the default directory where the QuickEnroll log resides.  No matter where the log file resides, access to it via browser will be restricted via an .htaccess redirect.',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Use a Custom Log Directory',
	'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS'	=> 'Provide a secure folder for storing QuickEnroll session information to prevent session data from being vulnerable on shared servers.',
	'LBL_SITECFG_CUSTOM_SESSION'		=> 'Use a Custom Session Directory for QuickEnroll',
	...
	'LBL_SITECFG_GLINT_UP_DIRECTIONS'	=> 'If checked, the system will periodically check to see if updated versions of the application are available.',
	'LBL_SITECFG_GLINT_UP'				=> 'Automatically Check For Updates?',
	'LBL_SITECFG_GLINT_UPDATES'			=> 'QuickEnroll Updates Config',
	'LBL_SITECFG_TITLE'					=> 'Site Configuration',
	'LBL_SITECFG_URL'					=> 'URL of QuickEnroll Instance',
	'LBL_SITECFG_USE_DEFAULTS'			=> 'Use Defaults?',
	'LBL_SITECFG_ANONSTATS'             => 'Send Anonymous Usage Statistics?',
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'        => 'If checked, QuickEnroll will send anonymous statistics about your installation to blumango Technologies Inc. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
	'LBL_START'							=> 'Start',
	'LBL_STEP'							=> 'Step',
	'LBL_TITLE_WELCOME'					=> 'Welcome to the QuickEnroll ',
	'LBL_WELCOME_1'						=> 'This installer creates the <b>QuickEnroll</b> database tables and sets the configuration variables that you need to start. The entire process should take about 5 minutes.',
	'LBL_WELCOME_2'						=> 'For installation documentation, please visit the <a href="http://www.blumango.com" target="_blank">BluMango</a>.',



	'LBL_WELCOME_CHOOSE_LANGUAGE'		=> 'Choose your language',
	'LBL_WELCOME_SETUP_WIZARD'			=> 'Setup Wizard',
	'LBL_WELCOME_TITLE_WELCOME'			=> 'Welcome to the QuickEnroll ',
	'LBL_WELCOME_TITLE'					=> 'QuickEnroll Setup Wizard',
	'LBL_WIZARD_TITLE'					=> 'QuickEnroll Setup Wizard: Step ',
	'LBL_YES'							=> 'Yes',
	...
	'LBL_SESSION_ERR_DESCRIPTION'		=> "QuickEnroll relies upon PHP sessions to store important information while connected to this web server.  Your PHP installation does not have the Session information correctly configured.  
	...
	'LBL_SYSTEM_NAME_INFO'=>'This will be displayed in the Title Bar of users who visit this QuickEnroll installation',
