...
$mod_strings = array (
	...
	'ERR_CHECKSYS_CURL'					=> '見つかりません: Sugarスケジューラーの機能は制限付きで動作します。',
	...
	'ERR_CHECKSYS_MEM_LIMIT_1'			=> '（php.iniで',
	...
	'ERR_CHECKSYS_SAFE_MODE'			=> 'Safe ModeがOnになっています (php.iniでOffに設定することもできます）',
	...
	'ERR_NO_SINGLE_QUOTE'				=> 'シングルクォーテーションは使用できません。',
	...
	'LBL_WELCOME_2'						=> 'SugarCRMインストール方法の詳細は <a href="http://docs.sugarforum.jp/" target="_blank">SugarCRM日本語ドキュメントプロジェクト</a>でご覧いただけます。<BR><BR>インストールに関しての質問は<a target="_blank" href="http://forum.sugarforum.jp/">SugarCRMオープンソースフォーラム</a>の「インストール＆アップグレード」に投稿してください。',
	...
	'LBL_MODULE_TITLE'					=> '言語パックをダウンロード＆インストール',
	'LBL_PATCH_1'						=> 'このステップをスキップしたい場合は、『次へ』をクリックしてください。',
	'LBL_PATCH_TITLE'					=> 'システムパッチ',
	'LBL_PATCH_READY'					=> '以下のパッチがインストール待ちです。',
	'LBL_SESSION_ERR_DESCRIPTION'		=> 'SugarCRMはウェブサーバに接続する際に、必要な情報をPHPセッションに保存しています。お使いのシステムではPHPセッションの保存場所が正しくありません。<br><br><b>session.save_path</b>が正しいディレクトリに設定されているかどうかご確認ください。<br><br>設定に問題がある場合は以下の場所にあるphp.iniの<a target=_new href="http://us2.php.net/manual/en/ref.session.php">PHP configuration</a>を変更してください。',
	'LBL_SESSION_ERR_TITLE'				=> 'PHPセッション設定エラー',
	'LBL_SYSTEM_NAME'					=> 'システム名',
	'LBL_SYSTEM_NAME_INFO'				=> 'このSugarCRMにアクセスした際にタイトルバーに表示される名称です。',
	'LBL_REQUIRED_SYSTEM_NAME'			=> 'システム名はブランクにできません',
	'LBL_PATCH_UPLOAD' 					=> 'パッチをアップロード'
);
