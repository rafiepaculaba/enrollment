...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
	    <th class="dataField" colspan="2" align="left"><h4 class="dataLabel"><img src="images/basic_search.gif" id="div5Handle" onclick="hideShowDiv('div5');" />&nbsp; 
	        Grade 5
	    </h4></th>
	</tr>
</table>
<div id="div5" style="display:block">
	...
	<?php
		...
		$this->db->where('yrLevel', 5);
		$this->subject5 = $this->User_model->retrieveAllSubjects();
		
		foreach ($this->subject5 as $curriculum_subject) {
			if (count($this->subject5) > 0) {
			 	$subject = $this->User_model->retrieveSubjects($curriculum_subject->subjID);
			 	if ($subject){
				...
				$this->enrollment = $this->User_model->retrieveEnrollments($this->enroll[0]->idno, $schYear[0]->definition);	
				if ($this->enrollment){
					$enID5 = $this->enrollment[0]->enID;
					$this->db->where('enID', $enID5);
				}
				$this->db->where('subjID',$curriculum_subject->subjID);
			 	$this->subj5_legend[$this->ctr] = '';

				if ($this->User_model->retrieveAllEnrollmentDetail()) {
			        // check for current enrollment 
		            $this->subj5_legend[$this->ctr]="clsCurrentEnroll";
	            } else if ( $this->User_model->checkForm137($curriculum_subject->subjID, $this->enroll[0]->idno)) {
	            	//check for taken subjects
	            	$this->subj5_legend[$this->ctr]="clsTaken";
			 	} else {
			 		$myTOR =  $this->User_model->getForm137($this->enroll[0]->idno);
                	if ($myTOR) {
                		$passed_subjects = "";
	...
	<tr height="20">
		<td scope="row" class="<?php if ($this->subj5_legend[$this->ctr]) { echo $this->subj5_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%"><?php echo $subject[0]->subjCode;?> </td>
		<td scope="row" class="<?php if ($this->subj5_legend[$this->ctr]) { echo $this->subj5_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%"><?php echo $subject[0]->descTitle;?> </td>
		<td scope="row" class="<?php if ($this->subj5_legend[$this->ctr]) { echo $this->subj5_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%"><?php echo $subject[0]->units;?> </td>
		<td scope="row" class="<?php if ($this->subj5_legend[$this->ctr]) { echo $this->subj5_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%">&nbsp;</td>
	</tr>
	<tr>
		<td colspan="20" class="listViewHRS1" height="1"></td>
	</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
	    <th class="dataField" colspan="2" align="left"><h4 class="dataLabel"><img src="images/basic_search.gif" id="div6Handle" onclick="hideShowDiv('div6');" />&nbsp; 
	        Grade 6
	    </h4></th>
	</tr>
</table>
<div id="div6" style="display:block">
	...
	<?php
		...
		$this->db->where('yrLevel', 6);
		$this->subject6 = $this->User_model->retrieveAllSubjects();
		
		foreach ($this->subject6 as $curriculum_subject) {
			if (count($this->subject6) > 0) {
			 	$subject = $this->User_model->retrieveSubjects($curriculum_subject->subjID);
			 	if ($subject){
				...
				$this->enrollment = $this->User_model->retrieveEnrollments($this->enroll[0]->idno, $schYear[0]->definition);	
				if ($this->enrollment){
					$enID6 = $this->enrollment[0]->enID;
					$this->db->where('enID', $enID6);
				}
				$this->db->where('subjID',$curriculum_subject->subjID);
			 	$this->subj6_legend[$this->ctr] = '';

				if ($this->User_model->retrieveAllEnrollmentDetail()) {
			        // check for current enrollment 
		            $this->subj6_legend[$this->ctr]="clsCurrentEnroll";
	            } else if ( $this->User_model->checkForm137($curriculum_subject->subjID, $this->enroll[0]->idno)) {
	            	//check for taken subjects
	            	$this->subj6_legend[$this->ctr]="clsTaken";
			 	} else {
			 		$myTOR =  $this->User_model->getForm137($this->enroll[0]->idno);
                	if ($myTOR) {
                		$passed_subjects = "";
	...
	<tr height="20">
		<td scope="row" class="<?php if ($this->subj6_legend[$this->ctr]) { echo $this->subj6_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%"><?php echo $subject[0]->subjCode;?> </td>
		<td scope="row" class="<?php if ($this->subj6_legend[$this->ctr]) { echo $this->subj6_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%"><?php echo $subject[0]->descTitle;?> </td>
		<td scope="row" class="<?php if ($this->subj6_legend[$this->ctr]) { echo $this->subj6_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%"><?php echo $subject[0]->units;?> </td>
		<td scope="row" class="<?php if ($this->subj6_legend[$this->ctr]) { echo $this->subj6_legend[$this->ctr]; } ?>" align="left" valign="top" width="10%">&nbsp;</td>
	</tr>
	<tr>
		<td colspan="20" class="listViewHRS1" height="1"></td>
	</tr>
