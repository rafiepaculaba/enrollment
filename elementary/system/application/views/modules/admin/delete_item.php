...
<tbody>
	<tr>
		...
		<td width="100%"><h2>Save Item</h2></td>
	</tr>
</tbody>
</table>
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr >
		<th colspan="4" align="left" class="dataLabel"><h4 class="dataLabel">Record successfully deleted !</h4></th>
	</tr>
</table>
<?php
	echo '<meta HTTP-EQUIV="REFRESH" content="3; url=index.php?admin/item_list/'.$lastID.'">'
?>
</p>