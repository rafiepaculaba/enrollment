...
class Grade extends Controller 
{
    ...
    function index()
	{
		...
		$this->load->view('modules/grade/current_grades');
...
/************************ START: ALL METHODS *********************************/	
	/**
	 * This will display the TOR
	 */
	function current_grades()
	{
		// tab settings
		require_once('includes/modules.php');
        ...
        $this->load->view('modules/grade/current_grades', $data);
		$this->load->view('footer');
	}
	...
	function form137()
	{
        ...
        $this->load->view('modules/grade/form137', $data);
		$this->load->view('footer');
	}
