...
//    	echo $this->db->last_query();
    ...
    function retrieveSchedulesSubj($subjID)
    {
     ...
     // This method will retrieve All Subjects
    function retrieveAllSubjects()
    {
    ...
    function retrieveForm137($idno, $subjID)
    {
    	$query = $this->db->query("SELECT * FROM `form137` Where idno = '".$idno."' and subjID = '".$subjID."'");
//    	echo $this->db->last_query();
    	return $query->result();
    }
...
//    	echo $this->db->last_query();
     ...
     // This method will retrieve Enrollment
    function retrieveEnrollments($idno, $schYear)
    {
    	$query = $this->db->query("SELECT * FROM `enrollments` Where idno = '$idno' and schYear = '$schYear' and rstatus > 0");
//    	echo $this->db->last_query();
    	return $query->result();
    }
    ...
    function checkForm137($subjID, $idno)
	{
        ...
        if ($grades) {
        	$query = $this->db->query("SELECT * FROM form137 where subjID='$subjID' and idno='$idno' and fgrade not in ($grades) and fgrade != '0'");
        	$records = $query->result();
	...
	function getForm137($idno)
	{
        ...
        $q = "SELECT * FROM form137 where idno='$idno' ";
