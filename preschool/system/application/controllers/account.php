...
class Account extends Controller 
{
    ...
    function index()
	{
		...
		$this->load->view('modules/account/statement_of_account');
		$this->load->view('footer');
	}

/************************ START: ALL METHODS *********************************/	
	/**
	 * This will display the list of assessments
	 */
	function assessmentlist()
	{
        ...
        $this->load->view('modules/account/assessmentlist', $data);
		$this->load->view('footer');
	}
	
	/**
	 * This will display the assessment
	 */
	function assessment()
	{
		// tab settings
        ...
        $this->load->view('modules/account/assessment', $data);
		$this->load->view('footer');
	}

	/**
	 * This will display the list of payments
	 */
	function paymentlist()
	{
        ...
        $this->load->view('modules/account/paymentlist', $data);
		$this->load->view('footer');
	}
	
	/**
	 * This will display the payment
	 */
	function payment()
	{
		// tab settings
        ...
        $this->load->view('modules/account/payment', $data);
		$this->load->view('footer');
	}
	
	/**
	 * This will display the statement of account
	 */
	function statement_of_account()
	{
		// tab settings
		require_once('includes/modules.php');
        ...
        $this->load->view('modules/account/statement_of_account', $data);
		$this->load->view('footer');
	}
	
	/**
	 * This will display the misc
	 */
	function misc()
	{
		// tab settings
...
//        $this->load->view('header', $data);
        ...
        $this->load->view('modules/account/misc', $data);
//		$this->load->view('footer');
	}
